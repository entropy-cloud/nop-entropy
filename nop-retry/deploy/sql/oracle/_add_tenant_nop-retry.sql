    ...
    alter table nop_retry_policy add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_retry_policy drop constraint PK_nop_retry_policy;
alter table nop_retry_policy add constraint PK_nop_retry_policy primary key (NOP_TENANT_ID, SID);
