...
public class NopRetryWebCodeGen {
    public static void main(String[] args) {
        ...
        try {
            File projectDir = MavenDirHelper.projectDir(NopRetryWebCodeGen.class);
            XCodeGenerator.runPostcompile(new File(projectDir, "../nop-retry-codegen"), "/", false);
