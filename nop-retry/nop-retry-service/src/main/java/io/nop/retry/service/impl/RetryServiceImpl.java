...
import io.nop.retry.api.IRetryService;
...
import io.nop.retry.service.scanner.IRetryScanner;
...
import static io.nop.retry.service.NopRetryErrors.*;

public class RetryServiceImpl extends LifeCycleSupport implements IRetryService {

    static final Logger LOG = LoggerFactory.getLogger(RetryServiceImpl.class);
