...
public abstract class _BeanValue extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    protected void outputJson(IJsonHandler out){
        ...
        out.putNotNull("autowire",this.getAutowire());
        out.putNotNull("autowireCandidate",this.isAutowireCandidate());
        out.putNotNull("className",this.getClassName());
        out.putNotNull("constructorArgs",this.getConstructorArgs());
        out.putNotNull("dependsOn",this.getDependsOn());
        out.putNotNull("destroyMethod",this.getDestroyMethod());
        out.putNotNull("factoryBean",this.getFactoryBean());
        out.putNotNull("factoryMethod",this.getFactoryMethod());
        out.putNotNull("initMethod",this.getInitMethod());
        out.putNotNull("iocAfter",this.getIocAfter());
        out.putNotNull("iocAop",this.isIocAop());
        out.putNotNull("iocAutoRefresh",this.isIocAutoRefresh());
        out.putNotNull("iocBeanMethod",this.getIocBeanMethod());
        out.putNotNull("iocBefore",this.getIocBefore());
        out.putNotNull("iocBuild",this.getIocBuild());
        out.putNotNull("iocCondition",this.getIocCondition());
        out.putNotNull("iocConfigPrefix",this.getIocConfigPrefix());
        out.putNotNull("iocDelayMethod",this.getIocDelayMethod());
        ...
        out.putNotNull("iocOnConfigRefresh",this.getIocOnConfigRefresh());
        out.putNotNull("iocProxy",this.isIocProxy());
        out.putNotNull("iocRefreshConfig",this.getIocRefreshConfig());
        out.putNotNull("iocRefreshConfigMethod",this.getIocRefreshConfigMethod());
        out.putNotNull("iocRestart",this.getIocRestart());
        out.putNotNull("iocRestartMethod",this.getIocRestartMethod());
        out.putNotNull("iocSecurityDomain",this.getIocSecurityDomain());
        out.putNotNull("iocType",this.getIocType());
        out.putNotNull("lazyInit",this.getLazyInit());
        out.putNotNull("parent",this.getParent());
