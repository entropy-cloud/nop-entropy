...
/**
 *  Report访问权限: nop_report_definition_auth
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopReportDefinitionAuth extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_rptId = 2;
    ...
    public _NopReportDefinitionAuth(){
        // for debug
    }

    protected NopReportDefinitionAuth newInstance(){
        NopReportDefinitionAuth entity = new NopReportDefinitionAuth();
    ...
    @Override
    public NopReportDefinitionAuth cloneInstance() {
        NopReportDefinitionAuth entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.report.dao.entity.NopReportDefinitionAuth";
    }
