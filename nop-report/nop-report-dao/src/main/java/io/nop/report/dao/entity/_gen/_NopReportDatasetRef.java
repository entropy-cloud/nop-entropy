...
/**
 *  报表引用数据源: nop_report_dataset_ref
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopReportDatasetRef extends DynamicOrmEntity{
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_rptId,PROP_NAME_dsId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_rptId,PROP_ID_dsId};
    ...
    public _NopReportDatasetRef(){
        // for debug
    }

    protected NopReportDatasetRef newInstance(){
        NopReportDatasetRef entity = new NopReportDatasetRef();
    ...
    @Override
    public NopReportDatasetRef cloneInstance() {
        NopReportDatasetRef entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.report.dao.entity.NopReportDatasetRef";
    }
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_rptId || propId == PROP_ID_dsId;
