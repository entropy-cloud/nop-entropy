...
/**
 *  数据集权限: nop_report_dataset_auth
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopReportDatasetAuth extends DynamicOrmEntity{
    ...
    /* 许可权限: PERMISSIONS VARCHAR */
    public static final String PROP_NAME_permissions = "permissions";
    public static final int PROP_ID_permissions = 3;
    ...
    public _NopReportDatasetAuth(){
        // for debug
    }

    protected NopReportDatasetAuth newInstance(){
        NopReportDatasetAuth entity = new NopReportDatasetAuth();
    ...
    @Override
    public NopReportDatasetAuth cloneInstance() {
        NopReportDatasetAuth entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.report.dao.entity.NopReportDatasetAuth";
    }
