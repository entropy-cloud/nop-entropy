...
public class _NopReportDefinition extends DynamicOrmEntity{
    ...
    public static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_rptId);
    public static final int[] PK_PROP_IDS = new int[]{PROP_ID_rptId};
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_rptText] = PROP_NAME_rptText;
          PROP_NAME_TO_ID.put(PROP_NAME_rptText, PROP_ID_rptText);
    ...
    /* 报表文件: RPT_TEXT */
    private java.lang.String _rptText;
    ...
    public String orm_entityName() {
      ...
      return "io.nop.report.dao.entity.NopReportDefinition";
    }
    ...
    public Object orm_id() {
        ...
        return buildSimpleId(PROP_ID_rptId);
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_rptName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_rptName));
               }
               setRptName(typedValue);
               break;
            }
            ...
            case PROP_ID_rptText:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_rptText));
               }
               setRptText(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_rptText:{
               onInitProp(propId);
               this._rptText = (java.lang.String)value;
