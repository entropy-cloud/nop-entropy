...
CREATE TABLE nop_report_dataset(
  SID VARCHAR(200) NOT NULL    COMMENT '主键',  DS_NAME VARCHAR(200) NOT NULL    COMMENT '数据集名称',
...
CREATE TABLE nop_report_datasource(
  SID VARCHAR(32) NOT NULL    COMMENT '主键ID',  NAME VARCHAR(100) NOT NULL    COMMENT '数据源名称',
...
CREATE TABLE nop_report_definition_auth(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  RPT_ID VARCHAR(32) NOT NULL    COMMENT '报表ID',
...
CREATE TABLE nop_report_dataset_ref(
  RPT_ID VARCHAR(32) NOT NULL    COMMENT '报表主键',  DS_ID VARCHAR(32) NOT NULL    COMMENT '数据集ID',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_report_result_file(
  SID VARCHAR(50) NOT NULL    COMMENT '主键',  FILE_NAME VARCHAR(200) NOT NULL    COMMENT '文件名称',
...
CREATE TABLE nop_report_sub_dataset(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  DS_ID VARCHAR(32) NOT NULL    COMMENT '数据集ID',
...
CREATE TABLE nop_report_datasource_auth(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  DATASOURCE_ID VARCHAR(32) NOT NULL    COMMENT '数据源ID',
  ROLE_ID VARCHAR(200) NOT NULL    COMMENT '角色ID',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
