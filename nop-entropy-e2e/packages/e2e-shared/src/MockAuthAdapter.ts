  ...
  data: {
    children: [
      ...
      },
      {
        ...
        component: 'FLUX',
        hidden: false,
        url: '/data/flux-demo.json',
        meta: { sort: 7 },
      },
      {
        id: 'flux-dashboard',
        displayName: 'Flux Dashboard',
        routePath: '/flux-dashboard',
        component: 'FLUX',
        hidden: false,
        url: '/data/flux-dashboard.json',
        meta: { sort: 8 },
      },
      {
        id: 'flux-report',
        displayName: 'Flux Report',
        routePath: '/flux-report',
        component: 'FLUX',
        hidden: false,
        url: '/data/flux-report.json',
        meta: { sort: 9 },
      },
      {
        id: 'flux-complex-form',
        displayName: 'Flux Complex Form',
        routePath: '/flux-complex-form',
        component: 'FLUX',
        hidden: false,
        url: '/data/flux-complex-form.json',
        meta: { sort: 10 },
      },
      {
        id: 'amis-tabs-test',
        displayName: 'AMIS Tabs Test',
        routePath: '/amis-tabs-test',
        component: 'AMIS',
        hidden: false,
        url: '/data/amis-tabs-test.json',
        meta: { sort: 999 },
      },
      {
        id: 'settings',
...
export const defaultMenuResponse = {
  ...
  items: [
    ...
    },
    {
      ...
      {
        id: 'amis-tabs-test',
        title: 'AMIS Tabs Test',
        path: '/amis-tabs-test',
        pageType: 'amis',
        schemaPath: '/data/amis-tabs-test.json',
        icon: 'list',
        sort: 999,
      },
      {
