---
name: frontend-monorepo-shell
description: (opencode-project - Skill) pnpm Monorepo 后台系统需求说明与生成提示词。用于从零搭建基于 pnpm monorepo 的前端后台管理系统，包含AI工作台、流程编排、插件系统等完整功能。触发词：前端后台、monorepo、pnpm、admin系统、插件系统。
---
