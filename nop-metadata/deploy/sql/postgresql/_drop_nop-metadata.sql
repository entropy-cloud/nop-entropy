...
drop table  if exists  nop_meta_reconciliation_entity;
drop table  if exists  nop_meta_model_changed_event;
drop table  if exists  nop_meta_glossary;
drop table  if exists  nop_meta_classification;
drop table  if exists  nop_meta_business_domain;
drop table  if exists  nop_meta_orm_model;
drop table  if exists  nop_meta_table;
drop table  if exists  nop_meta_pipeline;
drop table  if exists  nop_meta_quality_checkpoint;
drop table  if exists  nop_meta_manifest;
drop table  if exists  nop_meta_quality_result;
drop table  if exists  nop_meta_glossary_term;
drop table  if exists  nop_meta_tag;
drop table  if exists  nop_meta_data_product;
...
drop table  if exists  nop_meta_reconciliation_config;
drop table  if exists  nop_meta_quality_score;
drop table  if exists  nop_meta_lineage_edge;
drop table  if exists  nop_meta_tag_label;
...
drop table  if exists  nop_meta_reconciliation_result;
