...
CREATE TABLE nop_meta_module(
  ...
  MODULE_VERSION BIGINT NOT NULL    COMMENT '模块版本号',
...
CREATE TABLE nop_meta_quality_rule(
  ...
  SQL_EXPRESSION MEDIUMTEXT NULL    COMMENT 'SQL表达式',
...
CREATE TABLE nop_meta_model_changed_event(
  ...
  BEFORE_SNAPSHOT MEDIUMTEXT NULL    COMMENT '变更前快照',
  AFTER_SNAPSHOT MEDIUMTEXT NULL    COMMENT '变更后快照',
...
CREATE TABLE nop_meta_business_domain(
  BUSINESS_DOMAIN_ID VARCHAR(32) NOT NULL    COMMENT '业务域ID',
  PARENT_DOMAIN_ID VARCHAR(32) NULL    COMMENT '父域ID',
  NAME VARCHAR(100) NOT NULL    COMMENT '域名',
  DISPLAY_NAME VARCHAR(200) NULL    COMMENT '显示名',
  DESCRIPTION VARCHAR(1000) NULL    COMMENT '描述',
  DOMAIN_TYPE VARCHAR(20) NULL    COMMENT '业务域类型',
  EXPERTS VARCHAR(1000) NULL    COMMENT '专家列表',
  OWNERS VARCHAR(1000) NULL    COMMENT '负责人列表',
  EXT_CONFIG VARCHAR(4000) NULL    COMMENT '扩展配置',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE nop_meta_orm_model(
  ...
  SOURCE_CONTENT MEDIUMTEXT NULL    COMMENT '原始内容',
  IMPORTED_AT DATETIME(3) NULL    COMMENT '导入时间',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE nop_meta_table(
  ...
  SOURCE_SQL MEDIUMTEXT NULL    COMMENT '来源SQL',
  BASE_ENTITY_ID VARCHAR(32) NULL    COMMENT '主要实体ID',
  DESCRIPTION VARCHAR(1000) NULL    COMMENT '描述',
  BUILD_SQL MEDIUMTEXT NULL    COMMENT '合成SQL',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REMARK VARCHAR(200) NULL    COMMENT '备注',
  META_SCHEMA VARCHAR(100) NULL    COMMENT '源schema',
  BUSINESS_DOMAIN_ID VARCHAR(32) NULL    COMMENT '业务域ID',
...
CREATE TABLE nop_meta_pipeline(
  ...
  SOURCE_SQL MEDIUMTEXT NULL    COMMENT '处理SQL',
...
CREATE TABLE nop_meta_quality_checkpoint(
  ...
  DESCRIPTION VARCHAR(1000) NULL    COMMENT '描述',
  VALIDATIONS MEDIUMTEXT NULL    COMMENT '验证配置',
...
CREATE TABLE nop_meta_manifest(
  ...
  CONTENT MEDIUMTEXT NULL    COMMENT '快照内容',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_meta_data_product(
  DATA_PRODUCT_ID VARCHAR(32) NOT NULL    COMMENT '数据产品ID',
  BUSINESS_DOMAIN_ID VARCHAR(32) NOT NULL    COMMENT '所属业务域ID',
  NAME VARCHAR(100) NOT NULL    COMMENT '产品名',
  DISPLAY_NAME VARCHAR(200) NULL    COMMENT '显示名',
  DESCRIPTION VARCHAR(1000) NULL    COMMENT '描述',
  LIFECYCLE_STAGE VARCHAR(20) NULL    COMMENT '生命周期阶段',
  DATA_PRODUCT_TYPE VARCHAR(30) NULL    COMMENT '数据产品类型',
  VISIBILITY VARCHAR(20) NULL    COMMENT '可见性',
  PORTFOLIO_PRIORITY VARCHAR(10) NULL    COMMENT '投资组合优先级',
  SLA VARCHAR(4000) NULL    COMMENT 'SLA定义',
  CONSUMES_FROM VARCHAR(4000) NULL    COMMENT '依赖产品列表',
  PROVIDES_TO VARCHAR(4000) NULL    COMMENT '被依赖产品列表',
  EXPERTS VARCHAR(1000) NULL    COMMENT '专家列表',
  ASSETS VARCHAR(4000) NULL    COMMENT '关联资产列表',
  PORTS VARCHAR(4000) NULL    COMMENT '数据端口列表',
  EXT_CONFIG VARCHAR(4000) NULL    COMMENT '扩展配置',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE nop_meta_catalog(
  ...
  DETAILS MEDIUMTEXT NULL    COMMENT '扩展详情',
...
CREATE TABLE nop_meta_profiling_rule(
  ...
  RULE_NAME VARCHAR(100) NOT NULL    COMMENT '规则名',
  DISPLAY_NAME VARCHAR(200) NULL    COMMENT '显示名',
  META_TABLE_ID VARCHAR(32) NOT NULL    COMMENT '剖析表ID',
...
CREATE TABLE nop_meta_data_contract(
  ...
  DISPLAY_NAME VARCHAR(200) NULL    COMMENT '显示名',
  META_TABLE_ID VARCHAR(32) NULL    COMMENT '关联数据表ID',
  STATUS LONGTEXT NOT NULL    COMMENT '契约状态',
  OWNER_USER_ID VARCHAR(50) NULL    COMMENT '契约所有者',
  `SCHEMA` MEDIUMTEXT NULL    COMMENT 'JSON Schema 定义',
  ...
  LATEST_RESULT MEDIUMTEXT NULL    COMMENT '最新执行结果',
...
CREATE TABLE nop_meta_quality_score(
  ...
  DIMENSION_SCORES MEDIUMTEXT NULL    COMMENT '维度评分',
...
CREATE TABLE nop_meta_entity_field(
  ...
  IS_PRIMARY TINYINT default 0  NULL    COMMENT '主键',
...
CREATE TABLE nop_meta_entity_unique_key(
  ...
  CONSTRAINT_NAME VARCHAR(100) NULL    COMMENT '约束名',
  TAG_SET VARCHAR(500) NULL    COMMENT '标签集',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
...
CREATE TABLE nop_meta_table_join(
  ...
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REMARK VARCHAR(200) NULL    COMMENT '备注',
  LEFT_TABLE_ID VARCHAR(32) NULL    COMMENT '左表ID',
  RIGHT_TABLE_ID VARCHAR(32) NULL    COMMENT '右表ID',
...
CREATE TABLE nop_meta_dict_item(
  ...
  DEPRECATED TINYINT default 0  NULL    COMMENT '已废弃',
  INTERNAL TINYINT default 0  NULL    COMMENT '内部使用',
  IS_DELTA TINYINT default 0  NULL    COMMENT '是否Delta',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_meta_profiling_result(
  ...
  TABLE_STATS MEDIUMTEXT NULL    COMMENT '表级统计',
  COLUMN_STATS MEDIUMTEXT NULL    COMMENT '列级统计',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_meta_reconciliation_result(
  ...
  DETAILS MEDIUMTEXT NULL    COMMENT '明细',
  EXT_CONFIG VARCHAR(4000) NULL    COMMENT '扩展配置',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  ...
  constraint PK_nop_meta_reconciliation_result primary key (RESULT_ID)
   ...
   ALTER TABLE nop_meta_reconciliation_entity COMMENT '对账实体';
   ...
   ALTER TABLE nop_meta_business_domain COMMENT '业务组织域';
   ...
   ALTER TABLE nop_meta_data_product COMMENT '数据产品';
   ...
   ALTER TABLE nop_meta_reconciliation_config COMMENT '对账配置';
   ...
   ALTER TABLE nop_meta_reconciliation_result COMMENT '对账结果';
