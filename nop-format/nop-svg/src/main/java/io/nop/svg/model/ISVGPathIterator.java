...
/**
 * The <code>ISVGPathIterator</code> class represents a geometric path constructed from straight lines, quadratic and
 * cubic (Bezier) curves and elliptical arcs. This interface is identical to that of PathIterator except it can return
 * SEG_ARCTO from currentSegment, also the array of values passed to currentSegment must be of length 7 or an error will
 * be thrown.
 * <p>
 ...
 */
public interface ISVGPathIterator {
