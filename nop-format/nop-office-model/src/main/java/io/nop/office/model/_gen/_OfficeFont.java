...
/**
 * generate from /nop/schema/office/font.xdef <p>
 * 
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable",
    "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S101","java:S1128","java:S1161"})
public abstract class _OfficeFont extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private io.nop.office.model.constants.OfficeFontUnderline _underlineStyle ;
     ...
     * 
     */
    private io.nop.office.model.constants.OfficeFontVerticalAlign _verticalAlign ;
    ...
    public io.nop.office.model.constants.OfficeFontUnderline getUnderlineStyle(){
      return _underlineStyle;
    }

    
    public void setUnderlineStyle(io.nop.office.model.constants.OfficeFontUnderline value){
        checkAllowChange();
    ...
    public io.nop.office.model.constants.OfficeFontVerticalAlign getVerticalAlign(){
      return _verticalAlign;
    }

    
    public void setVerticalAlign(io.nop.office.model.constants.OfficeFontVerticalAlign value){
        checkAllowChange();
    ...
    public OfficeFont cloneInstance(){
        OfficeFont instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(OfficeFont instance){
    ...
    protected OfficeFont newInstance(){
        return (OfficeFont) ClassHelper.newInstance(getClass());
    }
}
