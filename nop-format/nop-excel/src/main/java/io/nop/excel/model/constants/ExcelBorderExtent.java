...
public enum ExcelBorderExtent {
    ...
    /**
     * All borders, that is top, bottom, left and right, including interior borders for the range. Does not include
     * diagonals which are different and not implemented here.
     */
    ALL,

    /**
     * All inside borders. This is top, bottom, left, and right borders, but restricted to the interior borders for the
     * range. For a range of one cell, this will produce no borders.
     */
    INSIDE,
