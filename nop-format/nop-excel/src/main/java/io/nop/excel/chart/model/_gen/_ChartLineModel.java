...
import io.nop.excel.chart.model.ChartLineModel;
...
public abstract class _ChartLineModel extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public ChartLineModel cloneInstance(){
        ChartLineModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(ChartLineModel instance){
    ...
    protected ChartLineModel newInstance(){
        return (ChartLineModel) ClassHelper.newInstance(getClass());
    }
}
