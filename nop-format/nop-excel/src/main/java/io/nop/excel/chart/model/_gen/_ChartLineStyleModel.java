...
public abstract class _ChartLineStyleModel extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public ChartLineStyleModel cloneInstance(){
        ChartLineStyleModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(ChartLineStyleModel instance){
    ...
    protected ChartLineStyleModel newInstance(){
        return (ChartLineStyleModel) ClassHelper.newInstance(getClass());
    }
}
