...
public class ChartManualLayoutBuilder {
    ...
    private void addLayoutModes(XNode manualLayoutNode, ChartManualLayoutModel layout) {
        ...
        if (layout.getPercentX() != null) {
            addModeElement(manualLayoutNode, "c:xMode", "factor");
        }
        
        if (layout.getPercentY() != null) {
            addModeElement(manualLayoutNode, "c:yMode", "factor");
        }
        
        if (layout.getPercentW() != null) {
            addModeElement(manualLayoutNode, "c:wMode", "factor");
        }
        
        if (layout.getPercentH() != null) {
            addModeElement(manualLayoutNode, "c:hMode", "factor");
        }
    }
