...
public class TestPieChartParser extends BaseTestCase {
    @BeforeAll
    ...
    public void testParseAndSaveBarChart() {
        IResource resource = new ClassPathResource("classpath:xlsx/test-pie-chart.xlsx");
        ...
        File targetFile = getTargetFile("generated-pie-chart.xlsx");
