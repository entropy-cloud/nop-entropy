...
import static io.nop.cluster.resources.MemorySize.MemoryUnit.BYTES;
import static io.nop.cluster.resources.MemorySize.MemoryUnit.GIGA_BYTES;
import static io.nop.cluster.resources.MemorySize.MemoryUnit.KILO_BYTES;
import static io.nop.cluster.resources.MemorySize.MemoryUnit.MEGA_BYTES;
import static io.nop.cluster.resources.MemorySize.MemoryUnit.TERA_BYTES;
import static io.nop.cluster.resources.MemorySize.MemoryUnit.hasUnit;
...
public class MemorySize implements java.io.Serializable, Comparable<MemorySize> {
    ...
    private static final List<MemoryUnit> ORDERED_UNITS =
            Arrays.asList(BYTES, KILO_BYTES, MemoryUnit.MEGA_BYTES, MemoryUnit.GIGA_BYTES, MemoryUnit.TERA_BYTES);
