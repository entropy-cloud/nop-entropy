...
/**
 *  应用模块映射: nop_dyn_app_module
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopDynAppModule extends DynamicOrmEntity{
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_appId,PROP_NAME_moduleId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_appId,PROP_ID_moduleId};
    ...
    public _NopDynAppModule(){
        // for debug
    }

    protected NopDynAppModule newInstance(){
        NopDynAppModule entity = new NopDynAppModule();
    ...
    @Override
    public NopDynAppModule cloneInstance() {
        NopDynAppModule entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.dyn.dao.entity.NopDynAppModule";
    }
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_appId || propId == PROP_ID_moduleId;
