...
public class NopDynCodeGen {
    public static void main(String[] args) {
        ...
        try {
            File projectDir = MavenDirHelper.projectDir(NopDynCodeGen.class);
            XCodeGenerator.runPostcompile(projectDir, "/", false);
            XCodeGenerator.runPrecompile(new File(projectDir, "../nop-dyn-core"), "/", false);
        } finally {
