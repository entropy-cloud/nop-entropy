...
CREATE TABLE nop_dyn_app(
  ...
  APP_VERSION INTEGER NOT NULL  default '1'    COMMENT '应用版本',
...
CREATE TABLE nop_dyn_module(
  ...
  MODULE_VERSION INTEGER NOT NULL  default '1'    COMMENT '模块版本',
  DISPLAY_NAME VARCHAR(200) NOT NULL    COMMENT '显示名',
...
CREATE TABLE nop_dyn_sql(
  ...
  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  NAME VARCHAR(100) NOT NULL  default 'pages'    COMMENT 'SQL名称',
  ...
  DISABLE_LOGICAL_DELETE TINYINT NULL  default '0'    COMMENT '禁用逻辑删除',
  ENABLE_FILTER TINYINT NULL  default '0'    COMMENT '启用数据权限',
  REFRESH_BEHAVIOR VARCHAR(10) NULL    COMMENT '实体刷新规则',
  COL_NAME_CAMEL_CASE TINYINT NULL  default '0'    COMMENT '列名需要转换为驼峰',
...
CREATE TABLE nop_dyn_page(
  ...
  PAGE_GROUP VARCHAR(100) NOT NULL  default 'pages'    COMMENT '页面分组',
...
CREATE TABLE nop_dyn_domain(
  ...
  SCALE INTEGER NULL  default '0'    COMMENT '小数位数',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
