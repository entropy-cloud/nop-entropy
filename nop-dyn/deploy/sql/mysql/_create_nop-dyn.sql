...
CREATE TABLE nop_dyn_app(
  ...
  APP_VERSION INTEGER default 1  NOT NULL    COMMENT '应用版本',
...
CREATE TABLE nop_dyn_module(
  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',  MODULE_NAME VARCHAR(100) NOT NULL    COMMENT '模块名',
  MODULE_VERSION INTEGER default 1  NOT NULL    COMMENT '模块版本',
  DISPLAY_NAME VARCHAR(200) NOT NULL    COMMENT '显示名',
...
CREATE TABLE nop_dyn_entity(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  NOP_OBJ_TYPE VARCHAR(100) NOT NULL    COMMENT '对象类型',
  ...
  NOP_TIMESTAMP_FLD1 DATETIME(3) NULL    COMMENT '时间戳字段1',
  ...
  NOP_TIMESTAMP_FLD2 DATETIME(3) NULL    COMMENT '时间戳字段2',
...
CREATE TABLE nop_dyn_entity_relation(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  RELATION_NAME VARCHAR(50) NOT NULL    COMMENT '关联名称',
...
CREATE TABLE nop_dyn_patch_file(
  FILE_ID VARCHAR(32) NOT NULL    COMMENT '文件ID',  APP_ID VARCHAR(32) NOT NULL    COMMENT 'App ID',
  MODULE_ID VARCHAR(32) NULL    COMMENT '模块ID',
  FILE_PATH VARCHAR(800) default 'pages'  NOT NULL    COMMENT '文件路径',
...
CREATE TABLE nop_dyn_module_dep(
  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',  DEP_MODULE_ID VARCHAR(32) NOT NULL    COMMENT '被依赖模块ID',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_dyn_app_module(
  APP_ID VARCHAR(32) NOT NULL    COMMENT '应用ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_dyn_sql(
  SQL_ID VARCHAR(32) NOT NULL    COMMENT 'SQL ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  NAME VARCHAR(100) default 'pages'  NOT NULL    COMMENT 'SQL名称',
  ...
  DISABLE_LOGICAL_DELETE TINYINT default 0  NULL    COMMENT '禁用逻辑删除',
  ENABLE_FILTER TINYINT default 0  NULL    COMMENT '启用数据权限',
  REFRESH_BEHAVIOR VARCHAR(10) NULL    COMMENT '实体刷新规则',
  COL_NAME_CAMEL_CASE TINYINT default 0  NULL    COMMENT '列名需要转换为驼峰',
...
CREATE TABLE nop_dyn_file(
  FILE_ID VARCHAR(32) NOT NULL    COMMENT '文件ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  FILE_NAME VARCHAR(200) NOT NULL    COMMENT '文件名称',
  FILE_PATH VARCHAR(800) default 'pages'  NOT NULL    COMMENT '文件路径',
  FILE_TYPE VARCHAR(50) NOT NULL    COMMENT '文件类型',
  FILE_LENGTH INTEGER NOT NULL    COMMENT '文件大小',
...
CREATE TABLE nop_dyn_page(
  PAGE_ID VARCHAR(32) NOT NULL    COMMENT '页面ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  PAGE_NAME VARCHAR(200) NOT NULL    COMMENT '页面名称',
  PAGE_GROUP VARCHAR(100) default 'pages'  NOT NULL    COMMENT '页面分组',
...
CREATE TABLE nop_dyn_entity_meta(
  ENTITY_META_ID VARCHAR(32) NOT NULL    COMMENT '实体定义ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
...
CREATE TABLE nop_dyn_domain(
  DOMAIN_ID VARCHAR(32) NOT NULL    COMMENT '数据域ID',  MODULE_ID VARCHAR(32) NOT NULL    COMMENT '模块ID',
  ...
  SCALE INTEGER default 0  NULL    COMMENT '小数位数',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_dyn_entity_relation_meta(
  REL_META_ID VARCHAR(32) NOT NULL    COMMENT '关联定义ID',  ENTITY_META_ID VARCHAR(32) NOT NULL    COMMENT '实体元数据',
  REF_ENTITY_META_ID VARCHAR(32) NOT NULL    COMMENT '关联实体',
  RELATION_NAME VARCHAR(100) NOT NULL    COMMENT '关联名',
  RELATION_DISPLAY_NAME VARCHAR(100) NOT NULL    COMMENT '关联显示名',
  RELATION_TYPE VARCHAR(10) NOT NULL    COMMENT '关联类型',
  MIDDLE_TABLE_NAME VARCHAR(100) NULL    COMMENT '中间表表名',
  MIDDLE_ENTITY_NAME VARCHAR(100) NULL    COMMENT '中间表实体名',
  LEFT_PROP_NAME VARCHAR(100) NOT NULL    COMMENT '左属性名',
  RIGHT_PROP_NAME VARCHAR(100) NOT NULL    COMMENT '右属性名',
  REF_SET_KEY_PROP VARCHAR(50) NULL    COMMENT '集合内唯一标识',
  REF_SET_SORT VARCHAR(100) NULL    COMMENT '集合排序条件',
  STATUS INTEGER NOT NULL    COMMENT '状态',
  TAGS_TEXT VARCHAR(200) NULL    COMMENT '标签',
  EXT_CONFIG VARCHAR(1000) NULL    COMMENT '扩展配置',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
...
CREATE TABLE nop_dyn_function_meta(
  FUNC_META_ID VARCHAR(32) NOT NULL    COMMENT '函数定义ID',  ENTITY_META_ID VARCHAR(32) NOT NULL    COMMENT '实体定义ID',
  ...
  STATUS INTEGER NOT NULL    COMMENT '状态',
  TAGS_TEXT VARCHAR(200) NULL    COMMENT '标签',
  SCRIPT_LANG VARCHAR(50) NULL    COMMENT '脚本语言',
...
CREATE TABLE nop_dyn_prop_meta(
  PROP_META_ID VARCHAR(32) NOT NULL    COMMENT '属性定义ID',  ENTITY_META_ID VARCHAR(32) NOT NULL    COMMENT '实体定义ID',
  ...
  constraint PK_nop_dyn_prop_meta primary key (PROP_META_ID)
   ...
   ALTER TABLE nop_dyn_entity_relation_meta COMMENT '实体关联属性定义';
