...
CREATE TABLE nop_dyn_patch_file(
  ...
  FILE_PATH VARCHAR2(800) default 'pages'  NOT NULL ,
...
CREATE TABLE nop_dyn_sql(
  ...
  MODULE_ID VARCHAR2(32) NOT NULL ,
  NAME VARCHAR2(100) default 'pages'  NOT NULL ,
...
CREATE TABLE nop_dyn_page(
  ...
  PAGE_GROUP VARCHAR2(100) default 'pages'  NOT NULL ,
