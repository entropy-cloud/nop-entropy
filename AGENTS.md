...
- `docs-for-ai/` is the primary guidance source, but if documentation and actual code behavior diverge, verify against the codebase and correct the docs as part of the task.
