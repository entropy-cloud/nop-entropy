...
- **Tech Stack**：Java（构建用 JDK 17+，编译目标 `maven.compiler.release=17`，见根 `pom.xml`），Maven，JUnit 5，XLang
- **文档新鲜度**：`fresh`

## Active Work

- **活跃计划**：`2026-07-18-0900-1` sql 视图字段类型推断（方案 B）/ `2026-07-18-0900-2` 聚合查询 having/排序增强（nop-metadata）
