...
- `docs-for-../04-core-components/ioc-guide.md`
...
- [Checkstyle配置](../03-development-guide/code-style-config.md) - 代码风格检查配置
- [开发规范](../03-development-guide/dev-standards.md) - 开发规范和最佳实践
