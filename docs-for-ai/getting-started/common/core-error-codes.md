...
- [错误码定义](./error-code.md)
- [DaoErrors接口](../../../../nop-persistence/nop-dao/src/main/java/io/nop/dao/DaoErrors.java)
- [ApiErrors接口](../../../../nop-kernel/nop-api-core/src/main/java/io/nop/api/core/ApiErrors.java)
