...
import io.nop.wf.biz.INopWfStatusHistoryBiz;

@BizModel("NopWfStatusHistory")
public class NopWfStatusHistoryBizModel extends CrudBizModel<NopWfStatusHistory> implements INopWfStatusHistoryBiz {
