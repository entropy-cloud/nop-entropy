...
CREATE TABLE nop_wf_definition(
  ...
  FORM_PATH VARCHAR(200) NULL    COMMENT '关联表单路径',
  STATUS INTEGER NOT NULL    COMMENT '状态',
  PUBLISHED_BY VARCHAR(50) NULL    COMMENT '发布人',
  PUBLISH_TIME DATETIME NULL    COMMENT '发布时间',
  ARCHIVED_BY VARCHAR(50) NULL    COMMENT '归档人',
  ARCHIVE_TIME DATETIME NULL    COMMENT '归档时间',
  IS_DEPRECATED BOOLEAN NOT NULL    COMMENT '是否已废弃',
...
CREATE TABLE nop_wf_instance(
  WF_ID VARCHAR(32) NOT NULL    COMMENT '主键',  WF_NAME VARCHAR(500) NOT NULL    COMMENT '工作流名称',
  WF_VERSION BIGINT NOT NULL    COMMENT '工作流版本',
  ...
  DUE_TIME DATETIME(3) NULL    COMMENT '完成时限',
  ...
  LAST_OPERATE_TIME DATETIME(3) NULL    COMMENT '上次操作时间',
...
CREATE TABLE nop_wf_definition_auth(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  WF_DEF_ID VARCHAR(32) NOT NULL    COMMENT '工作流定义ID',
...
CREATE TABLE nop_wf_status_history(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  WF_ID VARCHAR(32) NOT NULL    COMMENT '主键',
  ...
  CHANGE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '状态变动时间',
...
CREATE TABLE nop_wf_step_instance(
  STEP_ID VARCHAR(32) NOT NULL    COMMENT '步骤ID',  WF_ID VARCHAR(32) NOT NULL    COMMENT '工作流实例ID',
  ...
  IS_READ BOOLEAN default 0  NOT NULL    COMMENT '是否已读',
  ...
  DUE_TIME DATETIME(3) NULL    COMMENT '到期时间',
  READ_TIME DATETIME(3) NULL    COMMENT '读取时间',
  REMIND_TIME DATETIME(3) NULL    COMMENT '提醒时间',
  ...
  EXEC_GROUP VARCHAR(32) NULL    COMMENT '执行分组',
  EXEC_ORDER INTEGER NOT NULL    COMMENT '执行顺序',
  EXEC_COUNT INTEGER NULL    COMMENT '执行次数',
...
CREATE TABLE nop_wf_output(
  WF_ID VARCHAR(32) NOT NULL    COMMENT '工作流实例ID',  FIELD_NAME VARCHAR(100) NOT NULL    COMMENT '变量名',
...
CREATE TABLE nop_wf_step_instance_link(
  WF_ID VARCHAR(32) NOT NULL    COMMENT '工作流实例ID',  STEP_ID VARCHAR(32) NOT NULL    COMMENT '步骤ID',
...
CREATE TABLE nop_wf_action(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  WF_ID VARCHAR(32) NOT NULL    COMMENT '工作流实例ID',
  ...
  EXEC_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '执行时刻',
  CALLER_ID VARCHAR(50) NULL    COMMENT '调用者ID',
  CALLER_NAME VARCHAR(50) NULL    COMMENT '调用者姓名',
...
CREATE TABLE nop_wf_work(
  WORK_ID VARCHAR(32) NOT NULL    COMMENT '工作ID',  WF_ID VARCHAR(32) NULL    COMMENT '工作流实例ID',
...
CREATE TABLE nop_wf_log(
  SID VARCHAR(32) NOT NULL    COMMENT '日志ID',  WF_ID VARCHAR(32) NOT NULL    COMMENT '工作流实例ID',
  STEP_ID VARCHAR(32) NULL    COMMENT '工作流步骤ID',
