...
CREATE TABLE nop_wf_action(
  ...
  EXEC_TIME TIMESTAMP NOT NULL    COMMENT '执行时刻',
  CALLER_ID VARCHAR(50)     COMMENT '调用者ID',
  CALLER_NAME VARCHAR(50)     COMMENT '调用者姓名',
  OPINION VARCHAR(4000)     COMMENT '意见',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_wf_output(
  ...
  DECIMAL_VALUE DECIMAL(30,6)     COMMENT '浮点值',
  LONG_VALUE BIGINT     COMMENT '整数型',
  DATE_VALUE DATE     COMMENT '日期值',
  TIMESTAMP_VALUE TIMESTAMP     COMMENT '时间点值',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_wf_log(
  ...
  LOG_MSG VARCHAR(4000)     COMMENT '日志消息',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
...
CREATE TABLE nop_wf_work(
  ...
  STATUS INTEGER NOT NULL    COMMENT '状态',
  OWNER_ID VARCHAR(50)     COMMENT '拥有者ID',
...
CREATE TABLE nop_wf_step_instance(
  ...
  STATUS INTEGER NOT NULL    COMMENT '状态',
  APP_STATE VARCHAR(100)     COMMENT '应用状态',
  SUB_WF_ID VARCHAR(32)     COMMENT '子工作流ID',
  SUB_WF_NAME VARCHAR(200)     COMMENT '子工作流名',
  SUB_WF_VERSION VARCHAR(32)     COMMENT '子流程版本',
  IS_READ BOOLEAN     COMMENT '是否已读',
  ACTOR_TYPE VARCHAR(10)     COMMENT '参与者类型',
  ACTOR_ID VARCHAR(100)     COMMENT '参与者ID',
  ACTOR_DEPT_ID VARCHAR(50)     COMMENT '参与者部门ID',
  ACTOR_NAME VARCHAR(100)     COMMENT '参与者姓名',
  OWNER_ID VARCHAR(50)     COMMENT '拥有者ID',
  OWNER_NAME VARCHAR(50)     COMMENT '拥有者姓名',
  ASSIGNER_ID VARCHAR(50)     COMMENT '分配者ID',
  ASSIGNER_NAME VARCHAR(50)     COMMENT '分配者姓名',
  CALLER_ID VARCHAR(50)     COMMENT '调用者ID',
  CALLER_NAME VARCHAR(50)     COMMENT '调用者姓名',
  CANCELLER_ID VARCHAR(50)     COMMENT '取消人ID',
  CANCELLER_NAME VARCHAR(50)     COMMENT '取消人姓名',
  FROM_ACTION VARCHAR(200)     COMMENT '来源操作',
  LAST_ACTION VARCHAR(200)     COMMENT '最后一次操作',
  START_TIME TIMESTAMP     COMMENT '开始时间',
  FINISH_TIME TIMESTAMP     COMMENT '结束时间',
  DUE_TIME TIMESTAMP     COMMENT '到期时间',
  READ_TIME TIMESTAMP     COMMENT '读取时间',
  PRIORITY INTEGER NOT NULL    COMMENT '优先级',
  JOIN_TRACE VARCHAR(500)     COMMENT '汇聚路径',
  TAG_SET VARCHAR(200)     COMMENT '标签',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_wf_instance(
  ...
  WF_NAME VARCHAR(500) NOT NULL    COMMENT '工作流名称',
  WF_VERSION VARCHAR(50) NOT NULL    COMMENT '工作流版本',
  WF_PARAMS VARCHAR(4000)     COMMENT '工作流参数',
  TITLE VARCHAR(200) NOT NULL    COMMENT '实例标题',
  STATUS INTEGER NOT NULL    COMMENT '状态',
  APP_STATE VARCHAR(100)     COMMENT '应用状态',
  START_TIME TIMESTAMP     COMMENT '启动时间',
  END_TIME TIMESTAMP     COMMENT '结束时间',
  SUSPEND_TIME TIMESTAMP     COMMENT '暂停时间',
  DUE_TIME TIMESTAMP     COMMENT '完成时限',
  BIZ_KEY VARCHAR(200)     COMMENT '业务唯一键',
  BIZ_OBJ_NAME VARCHAR(200)     COMMENT '业务对象名',
  BIZ_OBJ_ID VARCHAR(200)     COMMENT '业务对象ID',
  PARENT_WF_NAME VARCHAR(500)     COMMENT '父工作流名称',
  PARENT_WF_VERSION VARCHAR(32)     COMMENT '父流程版本',
  PARENT_WF_ID VARCHAR(32)     COMMENT '父流程ID',
  PARENT_STEP_ID VARCHAR(200)     COMMENT '父流程步骤ID',
  STARTER_ID VARCHAR(50)     COMMENT '启动人ID',
  STARTER_NAME VARCHAR(50)     COMMENT '启动人',
  STARTER_DEPT_ID VARCHAR(50)     COMMENT '启动人单位ID',
  CANCELLER_ID VARCHAR(50)     COMMENT '取消人ID',
  CANCELLER_NAME VARCHAR(50)     COMMENT '取消人',
  SUSPENDER_ID VARCHAR(50)     COMMENT '暂停人ID',
  SUSPENDER_NAME VARCHAR(50)     COMMENT '暂停人',
  MANAGER_TYPE VARCHAR(50)     COMMENT '管理者类型',
  MANAGER_DEPT_ID VARCHAR(50)     COMMENT '管理者单位ID',
  MANAGER_NAME VARCHAR(50)     COMMENT '管理者',
  MANAGER_ID VARCHAR(50)     COMMENT '管理者ID',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
