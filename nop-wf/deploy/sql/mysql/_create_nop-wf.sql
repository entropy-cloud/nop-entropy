...
CREATE TABLE nop_wf_instance(
  ...
  LAST_OPERATE_TIME TIMESTAMP(3) NULL    COMMENT '上次操作时间',
...
CREATE TABLE nop_wf_status_history(
  ...
  CHANGE_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '状态变动时间',
...
CREATE TABLE nop_wf_step_instance(
  ...
  READ_TIME TIMESTAMP(3) NULL    COMMENT '读取时间',
  REMIND_TIME TIMESTAMP(3) NULL    COMMENT '提醒时间',
...
CREATE TABLE nop_wf_action(
  ...
  EXEC_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '执行时刻',
  CALLER_ID VARCHAR(50) NULL    COMMENT '调用者ID',
  CALLER_NAME VARCHAR(50) NULL    COMMENT '调用者姓名',
...
CREATE TABLE nop_wf_work(
  ...
  CALLER_NAME VARCHAR(50) NULL    COMMENT '调用者姓名',
  READ_TIME TIMESTAMP(3) NULL    COMMENT '读取时间',
  FINISH_TIME TIMESTAMP(3) NULL    COMMENT '完成时间',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
