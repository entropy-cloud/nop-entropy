...
alter table nop_wf_step_actor add column NOP_TENANT_ID VARCHAR(32) DEFAULT '0' NOT NULL;
...
alter table nop_wf_step_actor drop primary key;
alter table nop_wf_step_actor add primary key (NOP_TENANT_ID, SID);
