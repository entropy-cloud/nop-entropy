...
CREATE TABLE nop_wf_dyn_entity(
  SID VARCHAR2(32) NOT NULL ,
...
CREATE TABLE nop_wf_step_instance(
  ...
  SUB_WF_RESULT_STATUS INTEGER  ,
  IS_READ CHAR(1)  ,
  ACTOR_MODEL_ID VARCHAR2(100)  ,
  ...
  VOTE_WEIGHT INTEGER  ,
  EXEC_ORDER BINARY_DOUBLE NOT NULL ,
  JOIN_GROUP VARCHAR2(100)  ,
  TAG_TEXT VARCHAR2(200)  ,
  NEXT_STEP_ID VARCHAR2(32)  ,
  STEP_GROUP VARCHAR2(32)  ,
  VERSION INTEGER NOT NULL ,
  CREATED_BY VARCHAR2(50) NOT NULL ,
  CREATE_TIME TIMESTAMP NOT NULL ,
  UPDATED_BY VARCHAR2(50) NOT NULL ,
...
CREATE TABLE nop_wf_instance(
  ...
  WF_GROUP VARCHAR2(100) NOT NULL ,
  WORK_SCOPE VARCHAR2(100)  ,
  ...
  LAST_OPERATOR_ID VARCHAR2(50)  ,
  LAST_OPERATOR_NAME VARCHAR2(50)  ,
  LAST_OPERATOR_DEPT_ID VARCHAR2(50)  ,
  ...
  constraint PK_nop_wf_instance primary key (WF_ID)
      ...
      COMMENT ON TABLE nop_wf_dyn_entity IS '动态实体';
                
      COMMENT ON COLUMN nop_wf_dyn_entity.SID IS '主键';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.OBJ_TYPE IS '对象类型';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.NAME IS '名称';
      ...
      COMMENT ON COLUMN nop_wf_dyn_entity.PARENT_ID IS '父ID';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.OWNER_NAME IS '拥有者姓名';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.OWNER_ID IS '拥有者ID';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.DEPT_ID IS '部门ID';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.STRING_FLD1 IS '字符串字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.DECIMAL_FLD1 IS '浮点型字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.INT_FLD1 IS '整数型字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.LONG_FLD1 IS '长整型字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.DATE_FLD1 IS '日期字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.TIMESTAMP_FLD1 IS '时间戳字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.FILE_FLD1 IS '文件字段1';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.STRING_FLD2 IS '字符串字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.DECIMAL_FLD2 IS '浮点型字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.INT_FLD2 IS '整数型字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.LONG_FLD2 IS '长整型字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.DATE_FLD2 IS '日期字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.TIMESTAMP_FLD2 IS '时间戳字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.FILE_FLD2 IS '文件字段2';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.VERSION IS '数据版本';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.CREATED_BY IS '创建人';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.CREATE_TIME IS '创建时间';
                    
      COMMENT ON COLUMN nop_wf_dyn_entity.UPDATED_BY IS '修改人';
