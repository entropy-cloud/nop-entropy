    ...
    alter table nop_wf_action add column NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_wf_dyn_entity add column NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_wf_work add column NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
