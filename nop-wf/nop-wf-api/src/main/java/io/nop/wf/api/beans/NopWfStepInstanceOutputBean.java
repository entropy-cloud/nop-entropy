//__XGEN_FORCE_OVERRIDE__
    ...
    public class NopWfStepInstanceOutputBean {
        ...
        private String _stepType_label;

    
        public String getStepType_label(){
            return _stepType_label;
        }

        public void setStepType_label(String value){
            this._stepType_label = value;
        }
        ...
        private String _subWfResultStatus_label;

    
        public String getSubWfResultStatus_label(){
            return _subWfResultStatus_label;
        }

        public void setSubWfResultStatus_label(String value){
            this._subWfResultStatus_label = value;
        }
        ...
        private Map<String,Object> _subWfInstance;

        public Map<String,Object> getSubWfInstance(){
            return _subWfInstance;
        }

        public void setSubWfInstance(Map<String,Object> value){
            this._subWfInstance = value;
        }


        private List<Map<String,Object>> _nextLinks;

        public List<Map<String,Object>> getNextLinks(){
            return _nextLinks;
        }

        public void setNextLinks(List<Map<String,Object>> value){
            this._nextLinks = value;
        }


        private List<Map<String,Object>> _prevLinks;

        public List<Map<String,Object>> getPrevLinks(){
            return _prevLinks;
        }

        public void setPrevLinks(List<Map<String,Object>> value){
            this._prevLinks = value;
        }


        private List<Map<String,Object>> _stepActions;

        public List<Map<String,Object>> getStepActions(){
            return _stepActions;
        }

        public void setStepActions(List<Map<String,Object>> value){
