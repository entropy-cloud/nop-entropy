//__XGEN_FORCE_OVERRIDE__
    ...
    public class NopWfInstanceOutputBean {
        ...
        private List<Map<String,Object>> _statusHistories;

        public List<Map<String,Object>> getStatusHistories(){
            return _statusHistories;
        }

        public void setStatusHistories(List<Map<String,Object>> value){
            this._statusHistories = value;
        }


        private List<Map<String,Object>> _steps;

        public List<Map<String,Object>> getSteps(){
            return _steps;
        }

        public void setSteps(List<Map<String,Object>> value){
            this._steps = value;
        }


        private List<Map<String,Object>> _outputs;

        public List<Map<String,Object>> getOutputs(){
            return _outputs;
        }

        public void setOutputs(List<Map<String,Object>> value){
            this._outputs = value;
        }


        private List<Map<String,Object>> _globalVars;

        public List<Map<String,Object>> getGlobalVars(){
            return _globalVars;
        }

        public void setGlobalVars(List<Map<String,Object>> value){
            this._globalVars = value;
        }


        private List<Map<String,Object>> _works;

        public List<Map<String,Object>> getWorks(){
            return _works;
        }

        public void setWorks(List<Map<String,Object>> value){
            this._works = value;
        }
