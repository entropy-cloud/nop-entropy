...
/**
 *  可审批表单(工作流模式): nop_wf_approvable_form
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopWfApprovableForm extends DynamicOrmEntity{
    
    /* 主键: SID VARCHAR */
    public static final String PROP_NAME_sid = "sid";
    public static final int PROP_ID_sid = 1;
    
    /* 标题: FORM_TITLE VARCHAR */
    public static final String PROP_NAME_formTitle = "formTitle";
    public static final int PROP_ID_formTitle = 2;
    
    /* 审批状态: APPROVE_STATUS VARCHAR */
    public static final String PROP_NAME_approveStatus = "approveStatus";
    public static final int PROP_ID_approveStatus = 3;
    
    /* 审批人: APPROVED_BY VARCHAR */
    public static final String PROP_NAME_approvedBy = "approvedBy";
    public static final int PROP_ID_approvedBy = 4;
    
    /* 审批时间: APPROVED_AT DATETIME */
    public static final String PROP_NAME_approvedAt = "approvedAt";
    public static final int PROP_ID_approvedAt = 5;
    ...
    public static final int PROP_ID_nopFlowId = 11;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_formTitle] = PROP_NAME_formTitle;
          PROP_NAME_TO_ID.put(PROP_NAME_formTitle, PROP_ID_formTitle);
    ...
    /* 标题: FORM_TITLE */
    private java.lang.String _formTitle;
    ...
    public _NopWfApprovableForm(){
        // for debug
    }

    protected NopWfApprovableForm newInstance(){
        NopWfApprovableForm entity = new NopWfApprovableForm();
    ...
    @Override
    public NopWfApprovableForm cloneInstance() {
        NopWfApprovableForm entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.wf.dao.entity.NopWfApprovableForm";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_formTitle:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_formTitle));
               }
               setFormTitle(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_formTitle:{
               onInitProp(propId);
               this._formTitle = (java.lang.String)value;
     ...
     * 标题: FORM_TITLE
     */
    public final void setFormTitle(java.lang.String value){
        if(onPropSet(PROP_ID_formTitle,value)){
            this._formTitle = value;
            internalClearRefs(PROP_ID_formTitle);
