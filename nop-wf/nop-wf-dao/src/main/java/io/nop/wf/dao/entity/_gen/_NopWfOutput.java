...
public class _NopWfOutput extends DynamicOrmEntity{
    ...
    @Override
    public NopWfOutput cloneInstance() {
        NopWfOutput entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.wf.dao.entity.NopWfOutput";
    }
