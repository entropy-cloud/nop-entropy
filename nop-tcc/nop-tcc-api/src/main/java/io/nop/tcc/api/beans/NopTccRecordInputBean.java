//__XGEN_FORCE_OVERRIDE__
    ...
    public class NopTccRecordInputBean extends CrudInputBase {
        ...
        private List<NopTccBranchRecordInputBean> _branchRecords;

        public List<NopTccBranchRecordInputBean> getBranchRecords(){
            return _branchRecords;
        }

        public void setBranchRecords(List<NopTccBranchRecordInputBean> value){
