...
package io.nop.ooxml.common.model.internal;
 ...
 * </p>
 * <p>
 * Rule M1.13 : Package implementers shall only create and only recognize parts with a content type; format designers
 * shall specify a content type for each part included in the format. Content types for package parts shall fit the
 * definition and syntax for media types as specified in RFC 2616, \&#167;3.7.
 * </p>
 * <p>
 * Rule M1.14: Content types shall not use linear white space either between the type and subtype or between an
 * attribute and its value. Content types also shall not have leading or trailing white spaces. Package implementers
 * shall create only such content types and shall require such content types when retrieving a part from a package;
 * format designers shall specify only such content types for inclusion in the format.
 * </p>
 *
...
public final class ContentType {
    ...
    /**
     * Pattern to match on just the parameters part, to work around the Java Regexp group capture behaviour
     */
    ...
    static {
         ...
         *
         * Don't allow comment, rule M1.15: The package implementer shall require a content type that does not include
         * comments and the format designer shall specify such a content type.
         *
