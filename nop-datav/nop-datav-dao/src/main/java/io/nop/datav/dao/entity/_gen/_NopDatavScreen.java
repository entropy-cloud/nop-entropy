...
public class _NopDatavScreen extends DynamicOrmEntity{
    
    /* 大屏ID: SCREEN_ID VARCHAR */
    public static final String PROP_NAME_screenId = "screenId";
    public static final int PROP_ID_screenId = 1;
    
    /* 大屏名: SCREEN_NAME VARCHAR */
    public static final String PROP_NAME_screenName = "screenName";
    public static final int PROP_ID_screenName = 2;
    ...
    /* 画布宽度: SCREEN_WIDTH INTEGER */
    public static final String PROP_NAME_screenWidth = "screenWidth";
    public static final int PROP_ID_screenWidth = 5;
    
    /* 画布高度: SCREEN_HEIGHT INTEGER */
    public static final String PROP_NAME_screenHeight = "screenHeight";
    public static final int PROP_ID_screenHeight = 6;
    
    /* 适配模式: ADAPTOR_MODE INTEGER */
    public static final String PROP_NAME_adaptorMode = "adaptorMode";
    public static final int PROP_ID_adaptorMode = 7;
    
    /* 背景配置: BACKGROUND_CONFIG VARCHAR */
    public static final String PROP_NAME_backgroundConfig = "backgroundConfig";
    public static final int PROP_ID_backgroundConfig = 8;
    
    /* 发布状态: PUBLISH_STATUS INTEGER */
    public static final String PROP_NAME_publishStatus = "publishStatus";
    public static final int PROP_ID_publishStatus = 9;
    
    /* 已发布版本: PUBLISHED_VERSION BIGINT */
    public static final String PROP_NAME_publishedVersion = "publishedVersion";
    public static final int PROP_ID_publishedVersion = 10;
    
    /* 发布人: PUBLISHED_BY VARCHAR */
    public static final String PROP_NAME_publishedBy = "publishedBy";
    public static final int PROP_ID_publishedBy = 11;
    
    /* 发布时间: PUBLISHED_TIME TIMESTAMP */
    public static final String PROP_NAME_publishedTime = "publishedTime";
    public static final int PROP_ID_publishedTime = 12;
    ...
    /* component:  */
    public static final String PROP_NAME_backgroundConfigComponent = "backgroundConfigComponent";
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_screenName] = PROP_NAME_screenName;
          PROP_NAME_TO_ID.put(PROP_NAME_screenName, PROP_ID_screenName);
          ...
          PROP_ID_TO_NAME[PROP_ID_screenWidth] = PROP_NAME_screenWidth;
          PROP_NAME_TO_ID.put(PROP_NAME_screenWidth, PROP_ID_screenWidth);
      
          PROP_ID_TO_NAME[PROP_ID_screenHeight] = PROP_NAME_screenHeight;
          PROP_NAME_TO_ID.put(PROP_NAME_screenHeight, PROP_ID_screenHeight);
      
          PROP_ID_TO_NAME[PROP_ID_adaptorMode] = PROP_NAME_adaptorMode;
          PROP_NAME_TO_ID.put(PROP_NAME_adaptorMode, PROP_ID_adaptorMode);
      
          PROP_ID_TO_NAME[PROP_ID_backgroundConfig] = PROP_NAME_backgroundConfig;
          PROP_NAME_TO_ID.put(PROP_NAME_backgroundConfig, PROP_ID_backgroundConfig);
    ...
    /* 画布宽度: SCREEN_WIDTH */
    private java.lang.Integer _screenWidth;
    
    /* 画布高度: SCREEN_HEIGHT */
    private java.lang.Integer _screenHeight;
    
    /* 适配模式: ADAPTOR_MODE */
    private java.lang.Integer _adaptorMode;
    
    /* 背景配置: BACKGROUND_CONFIG */
    private java.lang.String _backgroundConfig;
    ...
    protected NopDatavScreen newInstance(){
        NopDatavScreen entity = new NopDatavScreen();
    ...
    @Override
    public NopDatavScreen cloneInstance() {
        NopDatavScreen entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.datav.dao.entity.NopDatavScreen";
    }
    ...
    public Object orm_id() {
        ...
        return buildSimpleId(PROP_ID_screenId);
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_screenId;
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_screenWidth:
               return getScreenWidth();
        
            case PROP_ID_screenHeight:
               return getScreenHeight();
        
            case PROP_ID_adaptorMode:
               return getAdaptorMode();
        
            case PROP_ID_backgroundConfig:
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_screenName:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_screenName));
               }
               setScreenName(typedValue);
               break;
            }
            ...
            case PROP_ID_screenWidth:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_screenWidth));
               }
               setScreenWidth(typedValue);
               break;
            }
            ...
            case PROP_ID_screenHeight:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_screenHeight));
               }
               setScreenHeight(typedValue);
               break;
            }
            ...
            case PROP_ID_adaptorMode:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_adaptorMode));
               }
               setAdaptorMode(typedValue);
               break;
            }
            ...
            case PROP_ID_backgroundConfig:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_backgroundConfig));
               }
               setBackgroundConfig(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_screenName:{
               onInitProp(propId);
               this._screenName = (java.lang.String)value;
            ...
            case PROP_ID_screenWidth:{
               onInitProp(propId);
               this._screenWidth = (java.lang.Integer)value;
            ...
            case PROP_ID_screenHeight:{
               onInitProp(propId);
               this._screenHeight = (java.lang.Integer)value;
            ...
            case PROP_ID_adaptorMode:{
               onInitProp(propId);
               this._adaptorMode = (java.lang.Integer)value;
            ...
            case PROP_ID_backgroundConfig:{
               onInitProp(propId);
               this._backgroundConfig = (java.lang.String)value;
     ...
     * 大屏名: SCREEN_NAME
     */
    public final void setScreenName(java.lang.String value){
        if(onPropSet(PROP_ID_screenName,value)){
            this._screenName = value;
            internalClearRefs(PROP_ID_screenName);
     ...
     * 画布宽度: SCREEN_WIDTH
     */
    public final void setScreenWidth(java.lang.Integer value){
        if(onPropSet(PROP_ID_screenWidth,value)){
            this._screenWidth = value;
            internalClearRefs(PROP_ID_screenWidth);
    ...
    public final java.lang.Integer getScreenHeight(){
         onPropGet(PROP_ID_screenHeight);
     ...
     * 画布高度: SCREEN_HEIGHT
     */
    public final void setScreenHeight(java.lang.Integer value){
        if(onPropSet(PROP_ID_screenHeight,value)){
            this._screenHeight = value;
            internalClearRefs(PROP_ID_screenHeight);
     ...
     * 适配模式: ADAPTOR_MODE
     */
    public final java.lang.Integer getAdaptorMode(){
         onPropGet(PROP_ID_adaptorMode);
         return _adaptorMode;
    }
     ...
     * 适配模式: ADAPTOR_MODE
     */
    public final void setAdaptorMode(java.lang.Integer value){
        if(onPropSet(PROP_ID_adaptorMode,value)){
            this._adaptorMode = value;
            internalClearRefs(PROP_ID_adaptorMode);
     ...
     * 背景配置: BACKGROUND_CONFIG
     */
    public final java.lang.String getBackgroundConfig(){
         onPropGet(PROP_ID_backgroundConfig);
     ...
     * 背景配置: BACKGROUND_CONFIG
     */
    public final void setBackgroundConfig(java.lang.String value){
        if(onPropSet(PROP_ID_backgroundConfig,value)){
            this._backgroundConfig = value;
            internalClearRefs(PROP_ID_backgroundConfig);
   ...
   private io.nop.orm.component.JsonOrmComponent _backgroundConfigComponent;

   private static Map<String,Integer> COMPONENT_PROP_ID_MAP_backgroundConfigComponent = new HashMap<>();
   static{
      
         COMPONENT_PROP_ID_MAP_backgroundConfigComponent.put(io.nop.orm.component.JsonOrmComponent.PROP_NAME__jsonText,PROP_ID_backgroundConfig);
      
   }

   public final io.nop.orm.component.JsonOrmComponent getBackgroundConfigComponent(){
      if(_backgroundConfigComponent == null){
          _backgroundConfigComponent = new io.nop.orm.component.JsonOrmComponent();
          _backgroundConfigComponent.bindToEntity(this, COMPONENT_PROP_ID_MAP_backgroundConfigComponent);
      }
      return _backgroundConfigComponent;
   }
