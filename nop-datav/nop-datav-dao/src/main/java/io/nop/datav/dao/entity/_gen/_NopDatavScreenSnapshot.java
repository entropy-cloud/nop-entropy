...
/**
 *  大屏快照: nop_datav_screen_snapshot
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopDatavScreenSnapshot extends DynamicOrmEntity{
    ...
    public _NopDatavScreenSnapshot(){
        // for debug
    }

    protected NopDatavScreenSnapshot newInstance(){
        NopDatavScreenSnapshot entity = new NopDatavScreenSnapshot();
    ...
    @Override
    public NopDatavScreenSnapshot cloneInstance() {
        NopDatavScreenSnapshot entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.datav.dao.entity.NopDatavScreenSnapshot";
    }
