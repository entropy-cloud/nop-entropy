...
public class MermaidLexer extends io.nop.antlr4.common.AbstractAntlrLexer {
	...
	public static final int
		...
		Identifier_=49, COMMENT=50, WS=51;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FLOWCHART", "SEQUENCE", "CLASS", "STATE", "GANTT", "PIE", "GIT", "ER", 
			"JOURNEY", "TB", "BT", "LR", "RL", "ROUND", "STADIUM", "SUBROUTINE", 
	...
	public MermaidLexer(CharStream input) {
		super(input);
