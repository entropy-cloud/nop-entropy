...
public abstract class _SqlValues extends EqlASTNode {
    ...
    public SqlValues newInstance(){
      return new SqlValues();
    }

    @Override
    public SqlValues deepClone(){
       SqlValues ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlValues other = (SqlValues)node;
