...
public abstract class _SqlAndExpr extends io.nop.orm.eql.ast.SqlExpr {
    ...
    public SqlAndExpr newInstance(){
      return new SqlAndExpr();
    }

    @Override
    public SqlAndExpr deepClone(){
       SqlAndExpr ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlAndExpr other = (SqlAndExpr)node;
