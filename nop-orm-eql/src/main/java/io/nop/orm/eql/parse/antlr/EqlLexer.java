...
public class EqlLexer extends io.nop.antlr4.common.AbstractAntlrLexer {
	...
	public static final int
		...
		STRING_=344, NUMBER_=345, HEX_DIGIT_=346, BIT_NUM_=347;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ESCAPE", "EXCEPT", "INTERCEPT", "EXCEPTION", "EXEC", "EXECUTE", "EXTERNAL", 
			"EXTRACT", "FETCH", "FIRST", "FOUND", "GET", "GLOBAL", "GO", "GOTO", 
			"IDENTITY", "IMMEDIATE", "INDICATOR", "INITIALLY", "INPUT", "INSENSITIVE", 
			"INTERSECT", "ISOLATION", "LANGUAGE", "LAST", "LEADING", "LEVEL", "LOWER", 
			"MATCH", "MODULE", "NATIONAL", "NCHAR", "NO", "NULLIF", "NUMERIC", "OCTET_LENGTH", 
