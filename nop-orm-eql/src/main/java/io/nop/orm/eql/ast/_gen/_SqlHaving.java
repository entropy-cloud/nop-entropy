...
public abstract class _SqlHaving extends EqlASTNode {
    ...
    public SqlHaving newInstance(){
      return new SqlHaving();
    }

    @Override
    public SqlHaving deepClone(){
       SqlHaving ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlHaving other = (SqlHaving)node;
