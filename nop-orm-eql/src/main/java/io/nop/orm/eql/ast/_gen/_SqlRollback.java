...
import io.nop.orm.eql.ast.SqlRollback;
...
public abstract class _SqlRollback extends io.nop.orm.eql.ast.SqlTransactionStatement {
    ...
    public SqlRollback newInstance(){
      return new SqlRollback();
    }

    @Override
    public SqlRollback deepClone(){
       SqlRollback ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlRollback other = (SqlRollback)node;
