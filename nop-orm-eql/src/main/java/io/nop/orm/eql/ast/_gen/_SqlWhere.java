...
public abstract class _SqlWhere extends EqlASTNode {
    ...
    public SqlWhere newInstance(){
      return new SqlWhere();
    }

    @Override
    public SqlWhere deepClone(){
       SqlWhere ret = newInstance();
