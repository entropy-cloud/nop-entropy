...
public abstract class _SqlNotExpr extends io.nop.orm.eql.ast.SqlExpr {
    ...
    public SqlNotExpr newInstance(){
      return new SqlNotExpr();
    }

    @Override
    public SqlNotExpr deepClone(){
       SqlNotExpr ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlNotExpr other = (SqlNotExpr)node;
