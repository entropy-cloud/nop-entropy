    ...
    alter table nop_job_definition add column NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_job_instance add column NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
