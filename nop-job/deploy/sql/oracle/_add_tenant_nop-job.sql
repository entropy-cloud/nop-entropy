...
alter table nop_job_assignment add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL
                ;

alter table nop_job_instance_his add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL
                ;
