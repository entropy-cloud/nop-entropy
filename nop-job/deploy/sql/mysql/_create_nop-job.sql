...
CREATE TABLE nop_job_definition(
  ...
  IS_FIXED_DELAY TINYINT NULL  default '0'    COMMENT '是否固定延时',
  ...
  IS_USE_DEFAULT_CALENDAR TINYINT NULL  default '0'    COMMENT '使用系统内置日历',
...
CREATE TABLE nop_job_instance(
  ...
  ONCE_TASK TINYINT NULL  default '0'    COMMENT '是否只执行一次',
