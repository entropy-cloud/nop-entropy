...
CREATE TABLE nop_job_definition(
  ...
  MIN_SCHEDULE_TIME TIMESTAMP NULL    COMMENT '最近调度时间',
  MAX_SCHEDULE_TIME TIMESTAMP NULL    COMMENT '最大调度时间',
  ...
  SCHEDULER_LOAD_TIME TIMESTAMP NULL    COMMENT '调度器加载时间',
...
CREATE TABLE nop_job_instance(
  ...
  JOB_INVOKER VARCHAR(200) NOT NULL    COMMENT '任务执行函数',
  STATUS INTEGER NOT NULL    COMMENT '任务状态',
  SCHEDULED_EXEC_TIME TIMESTAMP NULL    COMMENT '调度执行时间',
  EXEC_TIME TIMESTAMP NULL    COMMENT '实际执行时间',
