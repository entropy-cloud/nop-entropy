...
- 28. check-*.mjs migration manifest (per-script enumeration replacing the vague "25+", incl. check-silent-wrong-result's 5 sub-rules and check-bean-naming → XNode) + per-script switchover/decommission plan: `planned` (plan "2026-09-22-0854-3-check-scripts-migration-manifest", draft review approved 2026-09-22 via mission-driver REVIEW_PLANS #e18667f8; roadmap 行状态补记 2026-09-24, closure audit of item 25 flagged the stale state) — deps: 18, 21
