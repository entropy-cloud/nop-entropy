...
> 最后更新：2026-08-05（v17 — **MR6 R6.0 收口（plan-2026-08-05-2154-1）**：Backlog 32 条逐项裁决（计数勘误 33→32）——提级 12 条（安全 4：P2-10/11/12/13 + 正确性 5：P2-06/07/09/AR-07/AR-08 + 日志 3：P2-01/02/04，全部 live 复核确认）落 R6.1~R6.5 行、终局归类 20 条落 R6.6 行（AR-06 从提级清单移出补入 R6.6），0 悬置；R6.0 → done，R6.1~R6.6 Deps 门禁解除；裁决记录见 MR6 段下方记录块 + arm-index §P2（MR6 裁决记录段）。prior v16（MR6 段建立，计数 33/10/22 有误已勘误）保持不变）
