...
> 最后更新：2026-08-05（v18 — **MR6 R6.1 收口（plan-2026-08-05-2157-1）**：P2-10（custom_sql 黑名单 17→23 项补全 + judge 入口 6 绕过向量回归）+ P2-13（ExpressionMeasureValidator 死条目路径 A 拆分 + 5 回归测试）→ fixed，R6.1 → done；`./mvnw test -pl nop-metadata -am -T 1C` 901/0 全绿；arm-index §P2 P2-10/P2-13 行终态更新。prior v17（MR6 R6.0 收口：32 条逐项裁决 + 计数勘误 33→32 + R6.0 done）保持不变）
