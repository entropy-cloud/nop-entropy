...
> 最后更新：2026-08-05（v14 — MR5 R5.2 收口（plan-2026-08-05-1842-2）：血缘公开 API SQL 解析失败显式抛错落地（BizModel 边界 errors 非空即抛 + 表级/列级空 SQL 统一），894/0 全绿；R5.1/R5.2 done，R5.3 待 plan-2026-08-05-1842-3）；v13 的 MG 收尾记录保持不变
