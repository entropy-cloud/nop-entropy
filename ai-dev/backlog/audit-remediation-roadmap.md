...
> 最后更新：2026-08-01（v15 — 第十二批 0936-1 + 0936-2 + 0936-3 全部 closed + 1223-1 doc drift 收口：错误处理规范 agent/shell + core/coder + tools/toolkit 收口，P2-MA3-1/P3-MA3-1/P3-MA3-2/P3-MA3-3/P3-MA3-5 + toolkit 同规范残余 全部 fixed；0936-2 登记的 error-handling.md 语言例外条款 drift 由 1223-1 纯文档计划收口）
