...
- I8. truffle 多线程运行时（Context 池 + 共享 Engine + SHARED 形态）：`planned`（plan：`ai-dev/plans/xlang-execution-optimization/2026-08-21-0240-1-i8-truffle-multithread-runtime.md`，2026-08-21 起草并通过两轮独立子agent 审查至共识（round-1 Ready/0 Blocker + 2 Major advisory 修复；round-2 Ready/0 Blocker/0 Major，5/5 advisory 确认解决）） — 依赖：I7
