...
> Status: `planned` — go confirmed（blocking edge vision 决策已批准，选项 B 流式 + 物化点，2026-08-03）；successor plans：1/5 completed（#1 物化点机制 ✅）、2/5 active（#2 region 识别 / #3 supervision loop）、2/5 TBD（#4 drain/reconnect / #5 per-region counter）
