...
- A3-audit. 二期收口全量验证 + 独立 closure audit（全量 build/test + 零明文回归断言 + 一期功能零回归）：`todo` — 依赖：全部二期 impl + A1/A2 done；W16-impl-ext 的 roadmap 登记为 A3 收口前提（非其完成）
