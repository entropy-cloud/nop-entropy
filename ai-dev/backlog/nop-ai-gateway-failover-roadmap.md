...
- W6. 本地 IChatService 适配器 + 流式 failover（nop-ai-gateway：包装 ChatServiceImpl + accountKey/accountBaseUrl/model 下沉 + chunk 流层首段缓冲/重订阅）：`planned`（plan `2026-08-15-1116-2`，独立 draft review 三轮 consensus 通过）
