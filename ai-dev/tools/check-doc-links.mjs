...
const SKIP_FILES = new Set([
  ...
  // 第三方原文的正文路径（dsh/packages/... 等）指涉外部 dsh 仓库，非本仓库链接
  ...
  'ai-dev/references/dsh-community-articles/DeepSeek Harness 做Agent蒸馏 - 天然的蒸馏数据工厂.md',
  'ai-dev/references/dsh-community-articles/DSH - DeepSeek Harness 架构解析.md',
  'ai-dev/references/dsh-community-articles/看懂 Cordis，才能真正看懂 DeepSeek Harness.md',
  'ai-dev/references/dsh-community-articles/崔添翼最新论文 - DeepSeek Harness从插件机制开启自进化.md',
]);
