...
> 日期：2026-08-17
> 版本：v3（替代 v2；依据 `2026-08-17-revision-review.md` 修订；原 v1 稿未改动）
...
本文与 `2026-08-17-grc-dsh-theory-mapping.v3.md` 构成一对姊妹篇，分工如下：

- **本文（v3，工程+理论统一视角）**：从可逆计算（GRC）总理论出发，基于 dsh 源码核实，解释 dsh 架构设计并澄清常见误解；论证"GRC 是总理论，dsh 是 GRC 在运行时域的细化实例与形式化补充"。
- **姊妹篇 grc-mapping v3（纯理论对照）**：把本文的工程结论逐项映射到 GRC 文献。本文自包含，不依赖姊妹篇。

**两文的对应关系**：

| 本文（v3） | 姊妹篇 grc-mapping v3 |
|---|---|
