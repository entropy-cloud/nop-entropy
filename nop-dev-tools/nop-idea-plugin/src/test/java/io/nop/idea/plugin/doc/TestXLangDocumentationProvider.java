...
//        assertDoc(insertCaretIntoVfs("/test/doc/example.xdef", //
//                                     "<child name=\"string\"", //
//                                     "<child name=\"st<caret>ring\""), //
//                  (doc) -> {
//                      assertTrue(doc.contains("字符串类型"));
//                      assertTrue(doc.contains("/dict/core/std-domain.dict.yaml"));
//                  } //
//        );
        ...
        assertDoc("""
                          ...
                          """,  //
                  (doc) -> {
                      assertTrue(doc.contains("Leaf Node"));
                      assertTrue(doc.contains("/dict/test/doc/child-type.dict.yaml"));
                  } //
        );
    }
