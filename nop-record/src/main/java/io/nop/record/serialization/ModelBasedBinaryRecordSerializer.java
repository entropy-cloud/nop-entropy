...
public class ModelBasedBinaryRecordSerializer extends AbstractModelBasedRecordSerializer<IRecordBinaryWriter> {
    ...
    @Override
    protected void writeField0(IRecordBinaryWriter out, RecordFieldMeta field, Object record, IFieldCodecContext context) throws IOException {
    ...
    @Override
    protected IBitSet writeTags(IRecordBinaryWriter out, RecordFieldMeta field, RecordObjectMeta typeMeta, Object value, IFieldCodecContext context) throws IOException {
    ...
    @Override
    protected void writeObjectWithCodec(IRecordBinaryWriter out, RecordFieldMeta field, Object record, IFieldCodecContext context) throws IOException {
        IFieldBinaryCodec encoder = resolveBinaryCodec(field, registry);
    ...
    @Override
    protected void writeOffset(IRecordBinaryWriter out, int offset, IFieldCodecContext context) throws IOException {
    ...
    @Override
    protected void writeString(IRecordBinaryWriter out, String str, Charset charset, IFieldCodecContext context) throws IOException {
