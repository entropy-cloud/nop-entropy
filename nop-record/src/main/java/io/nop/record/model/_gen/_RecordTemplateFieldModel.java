...
public abstract class _RecordTemplateFieldModel extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public RecordTemplateFieldModel cloneInstance(){
        RecordTemplateFieldModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(RecordTemplateFieldModel instance){
    ...
    protected RecordTemplateFieldModel newInstance(){
        return (RecordTemplateFieldModel) ClassHelper.newInstance(getClass());
    }
}
