...
import io.nop.record.model.RecordMappingDefinitions;
...
public abstract class _RecordMappingDefinitions extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 数据对象属性映射规则
     */
    private KeyedList<io.nop.record.model.RecordMappingConfig> _mappings = KeyedList.emptyList();
    ...
    public java.util.List<io.nop.record.model.RecordMappingConfig> getMappings(){
      return _mappings;
    }

    
    public void setMappings(java.util.List<io.nop.record.model.RecordMappingConfig> value){
        checkAllowChange();
        
        this._mappings = KeyedList.fromList(value, io.nop.record.model.RecordMappingConfig::getName);
           
    }

    
    public io.nop.record.model.RecordMappingConfig getMapping(String name){
    ...
    public void addMapping(io.nop.record.model.RecordMappingConfig item) {
        checkAllowChange();
        java.util.List<io.nop.record.model.RecordMappingConfig> list = this.getMappings();
        if (list == null || list.isEmpty()) {
            list = new KeyedList<>(io.nop.record.model.RecordMappingConfig::getName);
            setMappings(list);
        }
        list.add(item);
    }
