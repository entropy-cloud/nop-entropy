...
public class BitmapTagBinaryCodec implements IFieldTagBinaryCodec {
    ...
    @Override
    public IBitSet decodeTags(IRecordBinaryInput input, RecordFieldMeta field, IFieldCodecContext context) {
    ...
    @Override
    public IBitSet encodeTags(IRecordBinaryOutput output, Object value, RecordFieldMeta field,
