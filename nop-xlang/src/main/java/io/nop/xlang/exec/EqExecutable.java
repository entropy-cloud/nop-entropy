...
public class EqExecutable extends AbstractBinaryExecutable {
    public EqExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
