...
public class LeExecutable extends AbstractBinaryExecutable {
    public LeExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
