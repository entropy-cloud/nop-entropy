...
public class GeExecutable extends AbstractBinaryExecutable {
    public GeExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
