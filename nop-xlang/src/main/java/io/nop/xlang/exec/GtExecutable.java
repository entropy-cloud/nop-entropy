...
public class GtExecutable extends AbstractBinaryExecutable {
    public GtExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
