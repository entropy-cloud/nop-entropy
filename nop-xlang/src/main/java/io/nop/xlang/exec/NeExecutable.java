...
public class NeExecutable extends AbstractBinaryExecutable {
    public NeExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
