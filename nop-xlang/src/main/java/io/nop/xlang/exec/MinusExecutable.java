...
public class MinusExecutable extends AbstractBinaryExecutable {
    public MinusExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
