...
public class DivideExecutable extends AbstractBinaryExecutable {
    public DivideExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
