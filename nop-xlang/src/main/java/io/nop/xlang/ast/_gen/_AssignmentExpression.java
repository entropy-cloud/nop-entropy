...
public abstract class _AssignmentExpression extends io.nop.xlang.ast.Statement {
    ...
    public AssignmentExpression newInstance(){
      return new AssignmentExpression();
    }

    @Override
    public AssignmentExpression deepClone(){
       AssignmentExpression ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    AssignmentExpression other = (AssignmentExpression)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.AssignmentExpression;
    }
