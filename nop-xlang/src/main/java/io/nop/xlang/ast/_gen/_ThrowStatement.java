...
public abstract class _ThrowStatement extends io.nop.xlang.ast.Statement {
    
    protected io.nop.xlang.ast.Expression argument;
    

    public _ThrowStatement(){
    }
    ...
    public ThrowStatement newInstance(){
      return new ThrowStatement();
    }

    @Override
    public ThrowStatement deepClone(){
       ThrowStatement ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    ThrowStatement other = (ThrowStatement)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.ThrowStatement;
    }
