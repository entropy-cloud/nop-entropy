...
public abstract class _ImportDeclaration extends io.nop.xlang.ast.ModuleDeclaration {
    
    protected io.nop.xlang.ast.Literal source;
    
    protected java.util.List<io.nop.xlang.ast.ModuleSpecifier> specifiers;
    

    public _ImportDeclaration(){
    }
    ...
    public java.util.List<io.nop.xlang.ast.ModuleSpecifier> getSpecifiers(){
        return specifiers;
    }

    public void setSpecifiers(java.util.List<io.nop.xlang.ast.ModuleSpecifier> value){
        checkAllowChange();
    ...
    public java.util.List<io.nop.xlang.ast.ModuleSpecifier> makeSpecifiers(){
        java.util.List<io.nop.xlang.ast.ModuleSpecifier> list = getSpecifiers();
        if(list == null){
    ...
    @Override
    public ImportDeclaration deepClone(){
       ImportDeclaration ret = newInstance();
    ...
    copyExtFieldsTo(ret);
                ...
                if(specifiers != null){
                          ...
                          java.util.List<io.nop.xlang.ast.ModuleSpecifier> copy_specifiers = new java.util.ArrayList<>(specifiers.size());
                          for(io.nop.xlang.ast.ModuleSpecifier item: specifiers){
    ...
    public void forEachChild(Consumer<XLangASTNode> processor){
            ...
            if(specifiers != null){
               for(io.nop.xlang.ast.ModuleSpecifier child: specifiers){
    ...
    public boolean replaceChild(XLangASTNode oldChild, XLangASTNode newChild){
            ...
            if(this.specifiers != null){
               ...
               if(index >= 0){
                   java.util.List<io.nop.xlang.ast.ModuleSpecifier> list = this.replaceInList(this.specifiers,index,newChild);
    ...
    public boolean removeChild(XLangASTNode child){
            ...
            if(this.specifiers != null){
               ...
               if(index >= 0){
                   java.util.List<io.nop.xlang.ast.ModuleSpecifier> list = this.removeInList(this.specifiers,index);
                   this.setSpecifiers(list);
                   return true;
               }
            }
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    ImportDeclaration other = (ImportDeclaration)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.ImportDeclaration;
    }
