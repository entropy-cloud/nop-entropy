...
public abstract class _UnaryExpression extends io.nop.xlang.ast.Expression {
    ...
    public UnaryExpression newInstance(){
      return new UnaryExpression();
    }

    @Override
    public UnaryExpression deepClone(){
       UnaryExpression ret = newInstance();
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.UnaryExpression;
    }
