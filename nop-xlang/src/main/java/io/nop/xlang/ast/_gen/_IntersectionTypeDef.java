...
public abstract class _IntersectionTypeDef extends io.nop.xlang.ast.StructuredTypeDef {
    
    protected java.util.List<io.nop.xlang.ast.NamedTypeNode> types;
    

    public _IntersectionTypeDef(){
    }
    ...
    public IntersectionTypeDef newInstance(){
      return new IntersectionTypeDef();
    }

    @Override
    public IntersectionTypeDef deepClone(){
       IntersectionTypeDef ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    IntersectionTypeDef other = (IntersectionTypeDef)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.IntersectionTypeDef;
    }
