...
public abstract class _BinaryExpression extends io.nop.xlang.ast.Expression {
    ...
    public BinaryExpression newInstance(){
      return new BinaryExpression();
    }

    @Override
    public BinaryExpression deepClone(){
       BinaryExpression ret = newInstance();
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.BinaryExpression;
    }
