...
public abstract class _OutputXmlAttrExpression extends io.nop.xlang.ast.OutputExpression {
    ...
    public _OutputXmlAttrExpression(){
    }
    ...
    public OutputXmlAttrExpression newInstance(){
      return new OutputXmlAttrExpression();
    }

    @Override
    public OutputXmlAttrExpression deepClone(){
       OutputXmlAttrExpression ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    OutputXmlAttrExpression other = (OutputXmlAttrExpression)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.OutputXmlAttrExpression;
    }
