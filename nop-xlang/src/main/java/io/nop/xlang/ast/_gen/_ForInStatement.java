...
public abstract class _ForInStatement extends io.nop.xlang.ast.Statement {
    ...
    public ForInStatement newInstance(){
      return new ForInStatement();
    }

    @Override
    public ForInStatement deepClone(){
       ForInStatement ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    ForInStatement other = (ForInStatement)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.ForInStatement;
    }
