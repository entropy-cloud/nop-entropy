...
public abstract class _MetaProperty extends XLangASTNode {
    
    protected io.nop.xlang.ast.Identifier name;
    
    protected io.nop.xlang.ast.XLangASTNode value;
    

    public _MetaProperty(){
    }
    ...
    public io.nop.xlang.ast.XLangASTNode getValue(){
        return value;
    }

    public void setValue(io.nop.xlang.ast.XLangASTNode value){
        checkAllowChange();
        if(value != null) value.setASTParent(this);
    ...
    public MetaProperty newInstance(){
      return new MetaProperty();
    }

    @Override
    public MetaProperty deepClone(){
       MetaProperty ret = newInstance();
    ...
    public boolean replaceChild(XLangASTNode oldChild, XLangASTNode newChild){
            ...
            if(this.value == oldChild){
               this.setValue((io.nop.xlang.ast.XLangASTNode)newChild);
               return true;
            }
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    MetaProperty other = (MetaProperty)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.MetaProperty;
    }
