...
public abstract class _TypeOfExpression extends io.nop.xlang.ast.Expression {
    
    protected io.nop.xlang.ast.Expression argument;
    

    public _TypeOfExpression(){
    }
    ...
    public TypeOfExpression newInstance(){
      return new TypeOfExpression();
    }

    @Override
    public TypeOfExpression deepClone(){
       TypeOfExpression ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    TypeOfExpression other = (TypeOfExpression)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.TypeOfExpression;
    }
