...
public abstract class _ConcatExpression extends io.nop.xlang.ast.Expression {
    
    protected java.util.List<io.nop.xlang.ast.Expression> expressions;
    

    public _ConcatExpression(){
    }
    ...
    public ConcatExpression newInstance(){
      return new ConcatExpression();
    }

    @Override
    public ConcatExpression deepClone(){
       ConcatExpression ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    ConcatExpression other = (ConcatExpression)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.ConcatExpression;
    }
