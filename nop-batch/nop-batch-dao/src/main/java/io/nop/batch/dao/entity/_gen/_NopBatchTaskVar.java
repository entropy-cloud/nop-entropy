...
public class _NopBatchTaskVar extends DynamicOrmEntity{
    ...
    public _NopBatchTaskVar(){
        // for debug
    }

    protected NopBatchTaskVar newInstance(){
        NopBatchTaskVar entity = new NopBatchTaskVar();
    ...
    @Override
    public NopBatchTaskVar cloneInstance() {
        NopBatchTaskVar entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.batch.dao.entity.NopBatchTaskVar";
    }
