...
CREATE TABLE nop_batch_record_result(
  ...
  RESULT_STATUS INTEGER     COMMENT '返回状态码',
  RESULT_CODE VARCHAR(100)     COMMENT '返回码',
  RESULT_MSG VARCHAR(500)     COMMENT '返回消息',
  ERROR_STACK VARCHAR(4000)     COMMENT '错误堆栈',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
...
CREATE TABLE nop_batch_task(
  ...
  START_TIME TIMESTAMP     COMMENT '任务启动时间',
  END_TIME TIMESTAMP     COMMENT '任务结束时间',
  TASK_PARAMS VARCHAR(4000)     COMMENT '任务参数',
  WORKER VARCHAR(100) NOT NULL    COMMENT '执行者',
  INPUT_FILE_ID VARCHAR(32)     COMMENT '输入文件',
  RETRY_COUNT INTEGER NOT NULL    COMMENT '重试次数',
  RESULT_STATUS INTEGER     COMMENT '返回状态码',
  RESULT_CODE VARCHAR(100)     COMMENT '返回码',
  RESULT_MSG VARCHAR(500)     COMMENT '返回消息',
  ERROR_STACK VARCHAR(4000)     COMMENT '错误堆栈',
  COMPLETED_INDEX BIGINT     COMMENT '已完成记录下标',
  READ_COUNT BIGINT     COMMENT '读数量',
  WRITE_COUNT BIGINT     COMMENT '写数量',
  PROCESS_COUNT BIGINT     COMMENT '处理数量',
  SKIP_COUNT BIGINT     COMMENT '跳过数量',
  VERSION BIGINT NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
