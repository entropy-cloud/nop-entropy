...
public abstract class _TableExistsPrecondition extends io.nop.core.resource.component.AbstractComponentModel {
    
    /**
     *  
     * xml name: expect
     * 期望结果：exists(存在) | notExists(不存在)
     */
    ...
    public TableExistsPrecondition cloneInstance(){
        TableExistsPrecondition instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(TableExistsPrecondition instance){
    ...
    protected TableExistsPrecondition newInstance(){
        return (TableExistsPrecondition) ClassHelper.newInstance(getClass());
    }
}
