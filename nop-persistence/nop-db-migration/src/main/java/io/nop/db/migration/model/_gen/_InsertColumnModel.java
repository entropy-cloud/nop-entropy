...
public abstract class _InsertColumnModel extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public InsertColumnModel cloneInstance(){
        InsertColumnModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(InsertColumnModel instance){
    ...
    protected InsertColumnModel newInstance(){
        return (InsertColumnModel) ClassHelper.newInstance(getClass());
    }
}
