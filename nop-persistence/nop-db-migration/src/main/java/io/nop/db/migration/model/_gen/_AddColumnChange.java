...
public abstract class _AddColumnChange extends io.nop.db.migration.model.DbChangeModel {
    ...
    public AddColumnChange cloneInstance(){
        AddColumnChange instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(AddColumnChange instance){
    ...
    protected AddColumnChange newInstance(){
        return (AddColumnChange) ClassHelper.newInstance(getClass());
    }
}
