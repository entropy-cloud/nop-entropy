...
public abstract class _DeleteDataChange extends io.nop.db.migration.model.DbChangeModel {
    ...
    public DeleteDataChange cloneInstance(){
        DeleteDataChange instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(DeleteDataChange instance){
    ...
    protected DeleteDataChange newInstance(){
        return (DeleteDataChange) ClassHelper.newInstance(getClass());
    }
}
