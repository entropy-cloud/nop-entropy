...
public abstract class _DropColumnChange extends io.nop.db.migration.model.DbChangeModel {
    ...
    public DropColumnChange cloneInstance(){
        DropColumnChange instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(DropColumnChange instance){
    ...
    protected DropColumnChange newInstance(){
        return (DropColumnChange) ClassHelper.newInstance(getClass());
    }
}
