...
public abstract class _SqlGroupByItem extends EqlASTNode {
    
    protected io.nop.orm.eql.ast.SqlExpr expr;
    

    public _SqlGroupByItem(){
    }
    ...
    public SqlGroupByItem newInstance(){
      return new SqlGroupByItem();
    }

    @Override
    public SqlGroupByItem deepClone(){
       SqlGroupByItem ret = newInstance();
    ...
    public boolean isEquivalentTo(EqlASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    SqlGroupByItem other = (SqlGroupByItem)node;
    ...
    public EqlASTKind getASTKind(){
       return EqlASTKind.SqlGroupByItem;
    }
