 ...
 * <p>
 * Properties of this enum correspond to attributes of the <i>spreadsheet</i> that are easily discernable to the user.
 * It is not intended to deal with low-level issues like file formats.
 */
public enum ExcelSpreadsheetVersion {
    /**
     ...
     * <li>Number of conditional format conditions on a cell is unlimited (actually limited by available memory in
     * Excel)</li>
    ...
    ExcelSpreadsheetVersion(int maxRows, int maxColumns, int maxFunctionArgs, int maxCondFormats,
                                    int maxCellStyles, int maxText) {
        _maxRows = maxRows;
    ...
    /**
     * @return the last valid column index in a ALPHA-26 representation (<code>IV</code> or <code>XFD</code>).
     */
    public String getLastColumnName() {
        return null; // ExcelCellReference.convertNumToColString(getLastColumnIndex());
    }
