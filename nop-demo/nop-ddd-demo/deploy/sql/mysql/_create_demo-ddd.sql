...
CREATE TABLE cargo(
  ID BIGINT NOT NULL    COMMENT 'Id',  CALCULATED_AT DATETIME NULL    COMMENT '计算时间',
...
CREATE TABLE carrier_movement(
  ID BIGINT NOT NULL    COMMENT 'Id',  ARRIVAL_TIME DATETIME NOT NULL    COMMENT '到达时间',
...
CREATE TABLE handling_event(
  ID BIGINT NOT NULL    COMMENT 'Id',  COMPLETION_TIME DATETIME NULL    COMMENT '完成时间',
...
CREATE TABLE leg(
  ID BIGINT NOT NULL    COMMENT 'Id',  LOAD_TIME DATETIME NULL    COMMENT '装货时间',
