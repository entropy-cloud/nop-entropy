//__XGEN_FORCE_OVERRIDE__
    ...
    public class LegOutputBean {
        ...
        private Map<String,Object> _loadLocation;

        public Map<String,Object> getLoadLocation(){
            return _loadLocation;
        }

        public void setLoadLocation(Map<String,Object> value){
        ...
        private Map<String,Object> _unloadLocation;

        public Map<String,Object> getUnloadLocation(){
            return _unloadLocation;
        }

        public void setUnloadLocation(Map<String,Object> value){
