...
/** 验证 Demo 模块的 flux.yaml 在 flux 模式下可加载。 */
...
public class TestFluxYamlPages extends JunitBaseTestCase {
    ...
    public void testDemoPages() {
        ...
        ResourceComponentManager.instance().clearCache("xlib");
        ResourceComponentManager.instance().clearCache("xpage");
        assertNotNull(pageProvider.getPage("/nop/demo/pages/Demo/edit-validator.flux.yaml", ""));
        assertNotNull(pageProvider.getPage("/nop/demo/pages/Demo/test-validator.flux.yaml", ""));
    }
}
