package io.nop.rule.core.service.impl;
    ...
    public class RuleServiceImpl implements RuleServiceSpi{
     ...
     @BizMutation
     @Override
     public java.util.Map executeRule(@RequestBean RuleRequestBean request, IServiceContext ctx){
        return null;
     }
            
     @BizQuery
     @Override
     public RuleMetaBean getRuleMeta(@RequestBean RuleKeyBean request, IServiceContext ctx){
        return null;
     }
