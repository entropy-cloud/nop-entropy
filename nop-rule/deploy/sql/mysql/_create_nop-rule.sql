...
CREATE TABLE nop_rule_node(
  SID VARCHAR(32) NOT NULL    COMMENT 'SID',  RULE_ID VARCHAR(32) NOT NULL    COMMENT '规则ID',
...
CREATE TABLE nop_rule_role(
  SID VARCHAR(32) NOT NULL    COMMENT '主键',  RULE_ID VARCHAR(32) NOT NULL    COMMENT 'Rule ID',
...
CREATE TABLE nop_rule_log(
  SID VARCHAR(32) NOT NULL    COMMENT '日志ID',  RULE_ID VARCHAR(32) NOT NULL    COMMENT '规则ID',
