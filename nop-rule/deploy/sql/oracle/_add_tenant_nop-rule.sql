    ...
    alter table nop_rule_definition add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_rule_log add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_rule_node add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_rule_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
