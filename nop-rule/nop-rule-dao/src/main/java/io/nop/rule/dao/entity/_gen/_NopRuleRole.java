...
public class _NopRuleRole extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_isAdmin] = PROP_NAME_isAdmin;
          PROP_NAME_TO_ID.put(PROP_NAME_isAdmin, PROP_ID_isAdmin);
    ...
    /* 是否管理者: IS_ADMIN */
    private java.lang.Byte _isAdmin;
    ...
    @Override
    public NopRuleRole cloneInstance() {
        NopRuleRole entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.rule.dao.entity.NopRuleRole";
    }
            ...
            case PROP_ID_isAdmin:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toByte(value,
                       err-> newTypeConversionError(PROP_NAME_isAdmin));
               }
               setIsAdmin(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_isAdmin:{
               onInitProp(propId);
               this._isAdmin = (java.lang.Byte)value;
