...
/**
 *  规则输入变量: nop_rule_input
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement"})
public class _NopRuleInput extends DynamicOrmEntity{
    ...
    public _NopRuleInput(){
    }

    protected NopRuleInput newInstance(){
       return new NopRuleInput();
    }

    @Override
    public NopRuleInput cloneInstance() {
        NopRuleInput entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.rule.dao.entity.NopRuleInput";
    }
