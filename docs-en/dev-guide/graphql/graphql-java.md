...
See the full implementation in [DevDocBizModel.java](https://gitee.com/canonical-entropy/nop-entropy/blob/master/nop-service-framework/nop-biz/src/main/java/io/nop/biz/dev/DevDocBizModel.java)
