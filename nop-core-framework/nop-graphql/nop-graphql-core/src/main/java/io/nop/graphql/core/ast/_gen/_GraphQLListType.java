...
public abstract class _GraphQLListType extends io.nop.graphql.core.ast.GraphQLType {
    
    protected io.nop.graphql.core.ast.GraphQLType type;
    

    public _GraphQLListType(){
    }
    ...
    public GraphQLListType newInstance(){
      return new GraphQLListType();
    }

    @Override
    public GraphQLListType deepClone(){
       GraphQLListType ret = newInstance();
    ...
    public boolean isEquivalentTo(GraphQLASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    GraphQLListType other = (GraphQLListType)node;
    ...
    public GraphQLASTKind getASTKind(){
       return GraphQLASTKind.GraphQLListType;
    }
