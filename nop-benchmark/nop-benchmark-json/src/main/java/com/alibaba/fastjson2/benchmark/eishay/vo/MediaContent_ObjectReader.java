        ...
        for (; ; ) {
            ...
            if (hashCode64 == -5533876349178564733L) { // media
                if (this.fieldObjectReader1 == null) {
                    this.fieldObjectReader1 = jsonReader.getContext().getObjectReader(Media.class); // media
                }
                object.setMedia((Media) fieldObjectReader1.readJSONBObject(jsonReader, 0));
                continue;
            }
            if (hashCode64 == -4924010017516690453L) { // images
                ...
                for (int j = 0; j < listItemCnt; ++j) {
                    list.add(fieldListItemReader0.readJSONBObject(jsonReader, 0));
                }
    ...
    public Object readObject(JSONReader jsonReader, long features) {
        ...
        for (; ; ) {
            ...
            if (hashCode64 == -5533876349178564733L) { // media
                ...
                object.setMedia((Media) fieldObjectReader1.readObject(jsonReader, 0));
                continue;
            }
            if (hashCode64 == -4924010017516690453L) { // images
                if (jsonReader.current() == '[') {
                    if (fieldListItemReader0 == null) {
                        fieldListItemReader0 = jsonReader.getContext().getObjectReader(Image.class);
                    }
                    ...
                    for (; ; ) {
                        ...
                        list.add(fieldListItemReader0.readObject(jsonReader, 0));
