...
import io.nop.rpc.RpcErrors;
import io.nop.rpc.exceptions.RpcTimeoutException;
...
import static io.nop.rpc.RpcErrors.ARG_MAX_WAIT_REQUESTS;
import static io.nop.rpc.RpcErrors.ARG_REQ_ID;
import static io.nop.rpc.RpcErrors.ARG_RPC_CHANNEL;
import static io.nop.rpc.RpcErrors.ERR_RPC_CHANNEL_CLOSED;
import static io.nop.rpc.RpcErrors.ERR_RPC_TOO_MANY_INFLIGHT_MESSAGES;
