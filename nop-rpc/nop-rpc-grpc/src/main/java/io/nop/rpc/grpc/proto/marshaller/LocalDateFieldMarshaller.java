...
public class LocalDateFieldMarshaller implements IFieldMarshaller {
    public static LocalDateFieldMarshaller INSTANCE = new LocalDateFieldMarshaller();

    static final int SIZE_NO_TAG = CodedOutputStream.computeStringSizeNoTag("2002-01-02");
    ...
    public Object readField(CodedInputStream in) throws IOException {
        return DateHelper.parseDate(in.readStringRequireUtf8());
    }
