...
public class _SimsExamExtField extends AbstractOrmKeyValueTable {
    ...
    public static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_examId, PROP_NAME_fieldName);
    public static final int[] PK_PROP_IDS = new int[]{PROP_ID_examId, PROP_ID_fieldName};
