    ...
    public void orm_propValue(int propId, Object value) {
        switch (propId) {
            ...
            case PROP_ID_sampleMethodId: {
                ...
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_sampleMethodId));
                }
            ...
            case PROP_ID_methodParamId: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_methodParamId));
                }
            ...
            case PROP_ID_numValue: {
                ...
                if (value != null) {
                    typedValue = ConvertHelper.toBigDecimal(value, err -> newTypeConversionError(PROP_NAME_numValue));
                }
    ...
    public void setSampleMethod(test.entity.TestOrmSampleMethod refEntity) {
        if (refEntity == null) {
            ...
            internalSetRefEntity(PROP_NAME_sampleMethod, refEntity, () -> {
                ...
                this.orm_propValue(PROP_ID_sampleMethodId, refEntity.getSid());
    ...
    public void setMethodParam(test.entity.TestOrmMethodParam refEntity) {
        if (refEntity == null) {
            ...
            internalSetRefEntity(PROP_NAME_methodParam, refEntity, () -> {
                ...
                this.orm_propValue(PROP_ID_methodParamId, refEntity.getSid());
