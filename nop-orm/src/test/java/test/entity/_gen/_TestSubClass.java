    ...
    public void orm_propValue(int propId, Object value) {
        switch (propId) {
            ...
            case PROP_ID_dupFld: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_dupFld));
                }
            ...
            case PROP_ID_testOrmExt: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_testOrmExt));
                }
