...
public class _TestOrmTable extends DynamicOrmEntity {
    ...
    public void orm_propValue(int propId, Object value) {
        switch (propId) {
            ...
            case PROP_ID_clobCol: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_clobCol));
                }
            ...
            case PROP_ID_numValue: {
                ...
                if (value != null) {
                    typedValue = ConvertHelper.toDouble(value, err -> newTypeConversionError(PROP_NAME_numValue));
                }
            ...
            case PROP_ID_sqlDateValue: {
                ...
                if (value != null) {
                    typedValue = ConvertHelper.toLocalDate(value, err -> newTypeConversionError(PROP_NAME_sqlDateValue));
                }
            ...
            case PROP_ID_jsonMap: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_jsonMap));
                }
            ...
            case PROP_ID_jsonList: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_jsonList));
                }
            ...
            case PROP_ID_version: {
                java.lang.Integer typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toInteger(value, err -> newTypeConversionError(PROP_NAME_version));
                }
            ...
            case PROP_ID_shardId: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_shardId));
                }
            ...
            case PROP_ID_subClassId: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_subClassId));
                }
            ...
            case PROP_ID_userId: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_userId));
                }
            ...
            case PROP_ID_parentId: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_parentId));
                }
            ...
            case PROP_ID_nopShard: {
                java.lang.String typedValue = null;
                if (value != null) {
                    typedValue = ConvertHelper.toString(value, err -> newTypeConversionError(PROP_NAME_nopShard));
                }
    ...
    public void setParent(test.entity.TestOrmTable refEntity) {
        if (refEntity == null) {
            ...
            internalSetRefEntity(PROP_NAME_parent, refEntity, () -> {
                ...
                this.orm_propValue(PROP_ID_parentId, refEntity.getSid());
    ...
    public void setTestOrmToOne(test.entity.TestOrmToOne refEntity) {
        if (refEntity == null) {
            ...
            internalSetRefEntity(PROP_NAME_testOrmToOne, refEntity, () -> {
                ...
                this.orm_propValue(PROP_ID_sid, refEntity.getSid());
    ...
    private final OrmEntitySet<test.entity.TestOrmOtherTable> _otherTables = new OrmEntitySet<>(this,
            PROP_NAME_otherTables, test.entity.TestOrmOtherTable.PROP_NAME_testOrmTable,
            test.entity.TestOrmOtherTable.PROP_NAME_strValue, test.entity.TestOrmOtherTable.class);
