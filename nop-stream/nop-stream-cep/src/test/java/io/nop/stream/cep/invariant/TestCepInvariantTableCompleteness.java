 ...
 */
package io.nop.stream.cep.invariant;
...
/**
 * Table completeness gate for the nop-stream-cep module (I1, 门禁基座): change-type method
 * table in {@code gate-inventory.json} vs live reflection, two-way exact equality. Same
 * classifier as {@code TestInvariantTableCompleteness} in nop-stream-core.
 */
public class TestCepInvariantTableCompleteness {

    static final String MODULE = "nop-stream-cep";
