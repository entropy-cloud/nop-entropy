...
/**
 * Internal interface for appending state that supports namespace-based partitioning.
 * <p>
 * This is a simplified version of Flink's InternalAppendingState, designed for
 ...
 * @param <OUT> The type of elements returned from the state
 */
public interface InternalAppendingState<K, N, IN, ACC, OUT> extends AppendingState<IN, OUT> {
    ...
    /**
     * Returns the accumulated value in the current namespace.
     *
