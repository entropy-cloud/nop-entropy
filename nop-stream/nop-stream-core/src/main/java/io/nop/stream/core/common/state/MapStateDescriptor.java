 ...
 * io.nop.stream.core.common.functions.RuntimeContext#getMapState(MapStateDescriptor)}.
 *
 ...
 * io.nop.stream.core.common.typeutils.NullableSerializer} at the cost of an extra byte in
 * the serialized form.
 *
