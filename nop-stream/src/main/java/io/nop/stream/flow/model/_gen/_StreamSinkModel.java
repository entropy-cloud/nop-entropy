...
public abstract class _StreamSinkModel extends io.nop.stream.flow.model.StreamTransformModel {
     ...
     * 
     */
    private io.nop.stream.core.common.functions.sink.SinkConsistencyCapability _consistencyCapability ;
     ...
     * 
     */
    private io.nop.core.type.IGenericType _inputType ;
    ...
    public io.nop.stream.core.common.functions.sink.SinkConsistencyCapability getConsistencyCapability(){
      return _consistencyCapability;
    }

    
    public void setConsistencyCapability(io.nop.stream.core.common.functions.sink.SinkConsistencyCapability value){
        checkAllowChange();
    ...
    public io.nop.core.type.IGenericType getInputType(){
      return _inputType;
    }

    
    public void setInputType(io.nop.core.type.IGenericType value){
        checkAllowChange();
    ...
    protected void outputJson(IJsonHandler out){
        ...
        out.putNotNull("inputType",this.getInputType());
    ...
    public StreamSinkModel cloneInstance(){
        StreamSinkModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(StreamSinkModel instance){
        super.copyTo(instance);
        
        instance.setConsistencyCapability(this.getConsistencyCapability());
        instance.setInputType(this.getInputType());
    ...
    protected StreamSinkModel newInstance(){
        return (StreamSinkModel) ClassHelper.newInstance(getClass());
    }
}
