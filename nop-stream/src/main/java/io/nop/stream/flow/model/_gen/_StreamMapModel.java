...
public abstract class _StreamMapModel extends io.nop.stream.flow.model.StreamTransformModel {
    ...
    public StreamMapModel cloneInstance(){
        StreamMapModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(StreamMapModel instance){
    ...
    protected StreamMapModel newInstance(){
        return (StreamMapModel) ClassHelper.newInstance(getClass());
    }
}
