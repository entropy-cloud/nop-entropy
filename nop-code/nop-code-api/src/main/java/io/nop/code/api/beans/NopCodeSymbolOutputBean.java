//__XGEN_FORCE_OVERRIDE__
    ...
    public class NopCodeSymbolOutputBean {
        ...
        private String _accessModifier_label;

    
        public String getAccessModifier_label(){
            return _accessModifier_label;
        }

        public void setAccessModifier_label(String value){
            this._accessModifier_label = value;
        }
        ...
        private Map<String,Object> _declaringSymbol;

        public Map<String,Object> getDeclaringSymbol(){
            return _declaringSymbol;
        }

        public void setDeclaringSymbol(Map<String,Object> value){
            this._declaringSymbol = value;
        }
