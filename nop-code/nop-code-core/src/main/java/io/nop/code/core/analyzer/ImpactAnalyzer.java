...
public class ImpactAnalyzer {
     ...
     * @param callGraph 调用图，支持 getCallees() 和 getCallers() 双向查询
     * @param symbolTable 符号表，支持按全限定名和ID查找
     ...
     * BFS 追踪影响范围
     *
     * @param startId 起始符号ID
     * @param callGraph 调用图
     * @param reverse true 表示上游（查找 callers），false 表示下游（查找 callees）
    ...
    private static String extractFilePath(CodeSymbol symbol) {
        // CodeSymbol 目前没有直接的 filePath，可以从 declaringSymbolId 追溯
        return null;
    }
