...
/**
 * Tests for CommunityDetector using Leiden and LabelPropagation algorithms.
 */
class TestCommunityDetector {
    ...
    private CallGraph buildTestGraph() {
        ...
        // E→F, F→E (isolated pair, mutually calling each other)
    ...
    void testLeidenEFCommunityCohesion() {
        ...
        // E and F only talk to each other, so they should form a community together
