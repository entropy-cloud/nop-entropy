...
public abstract class _GraphQLInputFieldDefinition extends io.nop.graphql.core.ast.WithDirectives {
    ...
    public _GraphQLInputFieldDefinition(){
    }
    ...
    public GraphQLInputFieldDefinition newInstance(){
      return new GraphQLInputFieldDefinition();
    }

    @Override
    public GraphQLInputFieldDefinition deepClone(){
       GraphQLInputFieldDefinition ret = newInstance();
    ...
    public boolean isEquivalentTo(GraphQLASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    GraphQLInputFieldDefinition other = (GraphQLInputFieldDefinition)node;
    ...
    public GraphQLASTKind getASTKind(){
       return GraphQLASTKind.GraphQLInputFieldDefinition;
    }
