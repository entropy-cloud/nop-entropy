...
public abstract class _GraphQLPropertyValue extends GraphQLASTNode {
    ...
    public GraphQLPropertyValue newInstance(){
      return new GraphQLPropertyValue();
    }

    @Override
    public GraphQLPropertyValue deepClone(){
       GraphQLPropertyValue ret = newInstance();
    ...
    public boolean isEquivalentTo(GraphQLASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    GraphQLPropertyValue other = (GraphQLPropertyValue)node;
    ...
    public GraphQLASTKind getASTKind(){
       return GraphQLASTKind.GraphQLPropertyValue;
    }
