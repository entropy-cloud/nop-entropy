...
public abstract class _GraphQLSelection extends io.nop.graphql.core.ast.WithDirectives {
    

    public _GraphQLSelection(){
    }
    ...
    @Override
    public abstract GraphQLSelection deepClone();
