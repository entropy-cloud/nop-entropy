...
CREATE TABLE nop_auth_user(
  ...
  CHANGE_PWD_AT_LOGIN SMALLINT default 0   ,
...
CREATE TABLE nop_auth_resource(
  ...
  NO_AUTH SMALLINT default 0  NOT NULL ,
...
CREATE TABLE nop_auth_user_substitution(
  SID VARCHAR2(32) NOT NULL ,
  USER_ID VARCHAR2(50) NOT NULL ,
  SUBSTITUTED_USER_ID VARCHAR2(50) NOT NULL ,
...
CREATE TABLE nop_auth_op_log(
  ...
  OPERATION VARCHAR2(800)  ,
  DESCRIPTION VARCHAR2(2000)  ,
  ACTION_TIME TIMESTAMP NOT NULL ,
  USED_TIME NUMBER(20) NOT NULL ,
  RESULT_STATUS INTEGER NOT NULL ,
  ERROR_CODE VARCHAR2(200)  ,
  RET_MESSAGE VARCHAR2(1000)  ,
  OP_REQUEST CLOB  ,
...
CREATE TABLE nop_auth_group_dept(
  DEPT_ID VARCHAR2(50) NOT NULL ,
  GROUP_ID VARCHAR2(50) NOT NULL ,
  INCLUDE_CHILD SMALLINT default 0  NOT NULL ,
  VERSION INTEGER NOT NULL ,
  CREATED_BY VARCHAR2(50) NOT NULL ,
  CREATE_TIME TIMESTAMP NOT NULL ,
  UPDATED_BY VARCHAR2(50) NOT NULL ,
