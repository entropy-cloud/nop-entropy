    ...
    alter table nop_auth_dept add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_position add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_site add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_role_data_auth add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_resource add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_ext_login add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_user_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_user_substitution add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_group add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_role_resource add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_group_dept add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_auth_group_user add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_auth_role add constraint UK_NOP_AUTH_ROLE_NAME unique (NOP_TENANT_ID,ROLE_NAME);

                alter table nop_auth_ext_login drop constraint UK_NOP_AUTH_EXT_LOGIN_TYPE_EXTID;
alter table nop_auth_ext_login add constraint UK_NOP_AUTH_EXT_LOGIN_TYPE_EXTID unique (NOP_TENANT_ID,LOGIN_TYPE,EXT_ID);
