...
CREATE TABLE nop_auth_role(
  ...
  IS_PRIMARY TINYINT NULL  default '0'    COMMENT '是否主角色',
...
CREATE TABLE nop_auth_user(
  ...
  EMAIL VARCHAR(100) NULL    COMMENT '邮件',
  EMAIL_VERIFIED TINYINT NULL  default '0'    COMMENT '邮件已验证',
  PHONE VARCHAR(50) NULL    COMMENT '电话',
  PHONE_VERIFIED TINYINT NULL  default '0'    COMMENT '电话已验证',
  ...
  CHANGE_PWD_AT_LOGIN TINYINT NULL  default '0'    COMMENT '登陆后立刻修改密码',
...
CREATE TABLE nop_auth_resource(
  ...
  KEEP_ALIVE TINYINT NOT NULL  default '0'    COMMENT '隐藏时保持状态',
  PERMISSIONS VARCHAR(200) NULL    COMMENT '权限标识',
  NO_AUTH TINYINT NOT NULL  default '0'    COMMENT '不检查权限',
  ...
  AUTH_CASCADE_UP TINYINT NULL  default '0'    COMMENT '自动更新父节点的权限',
...
CREATE TABLE nop_auth_op_log(
  ...
  ACTION_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '操作时间',
...
CREATE TABLE nop_auth_group_dept(
  ...
  INCLUDE_CHILD TINYINT NOT NULL  default '0'    COMMENT '是否包含下级',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
