...
CREATE TABLE nop_auth_ext_login(
  ...
  LAST_LOGIN_TIME TIMESTAMP(3) NULL    COMMENT '上次登录时间',
...
CREATE TABLE nop_auth_session(
  ...
  LOGIN_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '登录时间',
  LOGIN_TYPE INTEGER NOT NULL    COMMENT '登录方式',
  LOGOUT_TIME TIMESTAMP(3) NULL    COMMENT '退出时间',
...
CREATE TABLE nop_auth_op_log(
  ...
  ACTION_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '操作时间',
