//__XGEN_FORCE_OVERRIDE__
    ...
    public class NopAuthResource_mainOutputBean {
        ...
        private String _siteId_label;

    
        public String getSiteId_label(){
            return _siteId_label;
        }

        public void setSiteId_label(String value){
            this._siteId_label = value;
        }
        ...
        private String _resourceType_label;

    
        public String getResourceType_label(){
            return _resourceType_label;
        }

        public void setResourceType_label(String value){
            this._resourceType_label = value;
        }
