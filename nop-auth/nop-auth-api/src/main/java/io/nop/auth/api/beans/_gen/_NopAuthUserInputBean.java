//__XGEN_FORCE_OVERRIDE__
    ...
    public class _NopAuthUserInputBean extends CrudInputBase {
        ...
        private List<_NopAuthUserRoleInputBean> _roleMappings;

        public List<_NopAuthUserRoleInputBean> getRoleMappings(){
            return _roleMappings;
        }

        public void setRoleMappings(List<_NopAuthUserRoleInputBean> value){
            this._roleMappings = value;
        }


        private List<_NopAuthGroupUserInputBean> _groupMappings;

        public List<_NopAuthGroupUserInputBean> getGroupMappings(){
            return _groupMappings;
        }

        public void setGroupMappings(List<_NopAuthGroupUserInputBean> value){
