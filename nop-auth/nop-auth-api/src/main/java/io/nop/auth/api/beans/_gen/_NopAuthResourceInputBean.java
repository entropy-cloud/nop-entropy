//__XGEN_FORCE_OVERRIDE__
    ...
    public class _NopAuthResourceInputBean extends CrudInputBase {
        ...
        private List<_NopAuthRoleResourceInputBean> _roleMappings;

        public List<_NopAuthRoleResourceInputBean> getRoleMappings(){
            return _roleMappings;
        }

        public void setRoleMappings(List<_NopAuthRoleResourceInputBean> value){
