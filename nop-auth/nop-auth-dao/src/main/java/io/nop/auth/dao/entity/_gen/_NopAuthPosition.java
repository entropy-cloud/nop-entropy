...
public class _NopAuthPosition extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_positionId = 1;
    ...
    public static final int PROP_ID_delFlag = 3;
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_positionId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_positionId};
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthPosition";
    }
    ...
    public Object orm_id() {
        ...
        return buildSimpleId(PROP_ID_positionId);
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_positionId;
