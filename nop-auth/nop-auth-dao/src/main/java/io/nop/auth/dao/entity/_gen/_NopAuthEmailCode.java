...
/**
 *  邮件验证码: nop_auth_email_code
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopAuthEmailCode extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_email = 2;
    ...
    public _NopAuthEmailCode(){
        // for debug
    }

    protected NopAuthEmailCode newInstance(){
        NopAuthEmailCode entity = new NopAuthEmailCode();
    ...
    @Override
    public NopAuthEmailCode cloneInstance() {
        NopAuthEmailCode entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthEmailCode";
    }
