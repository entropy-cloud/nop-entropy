...
/**
 *  用户角色: nop_auth_user_role
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopAuthUserRole extends DynamicOrmEntity{
    ...
    public _NopAuthUserRole(){
        // for debug
    }

    protected NopAuthUserRole newInstance(){
        NopAuthUserRole entity = new NopAuthUserRole();
    ...
    @Override
    public NopAuthUserRole cloneInstance() {
        NopAuthUserRole entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthUserRole";
    }
