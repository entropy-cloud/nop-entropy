...
public class _NopAuthTenant extends DynamicOrmEntity{
    
    /* 主键: TENANT_ID VARCHAR */
    ...
    public static final int PROP_ID_beginTime = 3;
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_tenantId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_tenantId};
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthTenant";
    }
    ...
    public Object orm_id() {
        ...
        return buildSimpleId(PROP_ID_tenantId);
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_tenantId;
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_beginTime:{
               onInitProp(propId);
               this._beginTime = (java.time.LocalDateTime)value;
