...
/**
 *  用户代理: nop_auth_user_substitution
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopAuthUserSubstitution extends DynamicOrmEntity{
    ...
    /* 被代理的用户ID: SUBSTITUTED_USER_ID VARCHAR */
    ...
    public _NopAuthUserSubstitution(){
        // for debug
    }
    ...
    @Override
    public NopAuthUserSubstitution cloneInstance() {
        NopAuthUserSubstitution entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthUserSubstitution";
    }
