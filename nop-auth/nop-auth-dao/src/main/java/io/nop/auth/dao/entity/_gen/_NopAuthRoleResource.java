...
/**
 *  角色可访问资源: nop_auth_role_resource
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopAuthRoleResource extends DynamicOrmEntity{
    ...
    public _NopAuthRoleResource(){
        // for debug
    }

    protected NopAuthRoleResource newInstance(){
        NopAuthRoleResource entity = new NopAuthRoleResource();
    ...
    @Override
    public NopAuthRoleResource cloneInstance() {
        NopAuthRoleResource entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthRoleResource";
    }
