...
/**
 *  角色MFA策略: nop_auth_role_mfa_policy
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopAuthRoleMfaPolicy extends DynamicOrmEntity{
    
    /* 角色ID: ROLE_ID VARCHAR */
    public static final String PROP_NAME_roleId = "roleId";
    public static final int PROP_ID_roleId = 1;
    
    /* 最低MFA强度: MIN_MFA_LEVEL INTEGER */
    public static final String PROP_NAME_minMfaLevel = "minMfaLevel";
    public static final int PROP_ID_minMfaLevel = 2;
    
    /* 允许可信设备: ALLOW_TRUSTED_DEVICE TINYINT */
    public static final String PROP_NAME_allowTrustedDevice = "allowTrustedDevice";
    public static final int PROP_ID_allowTrustedDevice = 3;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_minMfaLevel] = PROP_NAME_minMfaLevel;
          PROP_NAME_TO_ID.put(PROP_NAME_minMfaLevel, PROP_ID_minMfaLevel);
      
          PROP_ID_TO_NAME[PROP_ID_allowTrustedDevice] = PROP_NAME_allowTrustedDevice;
          PROP_NAME_TO_ID.put(PROP_NAME_allowTrustedDevice, PROP_ID_allowTrustedDevice);
    ...
    /* 最低MFA强度: MIN_MFA_LEVEL */
    private java.lang.Integer _minMfaLevel;
    
    /* 允许可信设备: ALLOW_TRUSTED_DEVICE */
    private java.lang.Byte _allowTrustedDevice;
    ...
    public _NopAuthRoleMfaPolicy(){
        // for debug
    }

    protected NopAuthRoleMfaPolicy newInstance(){
        NopAuthRoleMfaPolicy entity = new NopAuthRoleMfaPolicy();
    ...
    @Override
    public NopAuthRoleMfaPolicy cloneInstance() {
        NopAuthRoleMfaPolicy entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.auth.dao.entity.NopAuthRoleMfaPolicy";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_minMfaLevel:
               return getMinMfaLevel();
        
            case PROP_ID_allowTrustedDevice:
               return getAllowTrustedDevice();
            ...
            case PROP_ID_minMfaLevel:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_minMfaLevel));
               }
               setMinMfaLevel(typedValue);
               break;
            }
            ...
            case PROP_ID_allowTrustedDevice:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toByte(value,
                       err-> newTypeConversionError(PROP_NAME_allowTrustedDevice));
               }
               setAllowTrustedDevice(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_minMfaLevel:{
               onInitProp(propId);
               this._minMfaLevel = (java.lang.Integer)value;
            ...
            case PROP_ID_allowTrustedDevice:{
               onInitProp(propId);
               this._allowTrustedDevice = (java.lang.Byte)value;
     ...
     * 最低MFA强度: MIN_MFA_LEVEL
     */
    public final java.lang.Integer getMinMfaLevel(){
         onPropGet(PROP_ID_minMfaLevel);
         return _minMfaLevel;
    }
     ...
     * 最低MFA强度: MIN_MFA_LEVEL
     */
    public final void setMinMfaLevel(java.lang.Integer value){
        if(onPropSet(PROP_ID_minMfaLevel,value)){
            this._minMfaLevel = value;
            internalClearRefs(PROP_ID_minMfaLevel);
     ...
     * 允许可信设备: ALLOW_TRUSTED_DEVICE
     */
    public final java.lang.Byte getAllowTrustedDevice(){
         onPropGet(PROP_ID_allowTrustedDevice);
     ...
     * 允许可信设备: ALLOW_TRUSTED_DEVICE
     */
    public final void setAllowTrustedDevice(java.lang.Byte value){
        if(onPropSet(PROP_ID_allowTrustedDevice,value)){
            this._allowTrustedDevice = value;
            internalClearRefs(PROP_ID_allowTrustedDevice);
