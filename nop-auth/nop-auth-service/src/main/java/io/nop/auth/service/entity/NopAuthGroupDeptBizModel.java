...
import io.nop.auth.biz.INopAuthGroupDeptBiz;

@BizModel("NopAuthGroupDept")
public class NopAuthGroupDeptBizModel extends CrudBizModel<NopAuthGroupDept> implements INopAuthGroupDeptBiz {
