    ...
    alter table nop_oauth_authorization add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL
                ;

alter table nop_oauth_authorization_consent add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL
                ;

alter table nop_oauth_registered_client add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL
                ;
