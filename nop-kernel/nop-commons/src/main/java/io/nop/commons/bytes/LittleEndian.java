...
/**
 * a utility class for handling little-endian numbers, which the 80x86 world is replete with. The methods are all
 * static, and input/output is from/to byte arrays, or from InputStreams.
 */
public final class LittleEndian {
    ...
    /**
     * get a double value from a byte array, reads it in little endian format then converts the resulting revolting IEEE
     * 754 (curse them) floating point number to a happy java double
     *
    ...
    /**
     * get a float value from a byte array, reads it in little endian format then converts the resulting revolting IEEE
     * 754 (curse them) floating point number to a happy java float
     *
     * @param data the byte array
     * @return the double (64-bit) value
     */
