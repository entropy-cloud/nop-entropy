...
public abstract class _DeleteStatement extends io.nop.xlang.ast.Statement {
    
    protected io.nop.xlang.ast.Expression argument;
    

    public _DeleteStatement(){
    }
    ...
    public DeleteStatement newInstance(){
      return new DeleteStatement();
    }

    @Override
    public DeleteStatement deepClone(){
       DeleteStatement ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    DeleteStatement other = (DeleteStatement)node;
    ...
    public XLangASTKind getASTKind(){
       return XLangASTKind.DeleteStatement;
    }
