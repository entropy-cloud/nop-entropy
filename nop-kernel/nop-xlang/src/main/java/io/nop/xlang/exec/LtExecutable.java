...
public class LtExecutable extends AbstractBinaryExecutable {
    public LtExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
