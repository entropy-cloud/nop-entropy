...
public class StrictEqExecutable extends AbstractBinaryExecutable {
    public StrictEqExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
