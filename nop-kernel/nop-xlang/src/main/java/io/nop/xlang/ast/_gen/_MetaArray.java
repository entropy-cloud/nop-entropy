...
public abstract class _MetaArray extends XLangASTNode {
    ...
    public MetaArray newInstance(){
      return new MetaArray();
    }

    @Override
    public MetaArray deepClone(){
       MetaArray ret = newInstance();
    ...
    public boolean isEquivalentTo(XLangASTNode node){
       if(this.getASTKind() != node.getASTKind())
          return false;
    MetaArray other = (MetaArray)node;
