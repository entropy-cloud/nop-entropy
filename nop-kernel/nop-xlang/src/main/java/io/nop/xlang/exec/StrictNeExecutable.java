...
public class StrictNeExecutable extends AbstractBinaryExecutable {
    public StrictNeExecutable(SourceLocation loc, IExecutableExpression left, IExecutableExpression right) {
