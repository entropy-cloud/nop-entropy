...
```xml
<site>
    <resource displayName="chinese" icon="awesome-font" id="unique-english" routePath="unique-module-path">
        <children>
            <resource app:entityName="entity-name" app:pageName="string" displayName="chinese" icon="awesome-font"
                      id="unique-page-id"/>
        </children>
    </resource>
</site>
