...
<auth>
    <site>
        <resource id="unique-english" displayName="chinese" icon="awesome-font" routePath="unique-module-path">
            <children>
                <resource id="unique-page-id" displayName="chinese" icon="awesome-font" app:entityName="entity-name"
                          app:pageName="string" role="role-csv-set"/>
            </children>
        </resource>
    </site>
    <roles>
