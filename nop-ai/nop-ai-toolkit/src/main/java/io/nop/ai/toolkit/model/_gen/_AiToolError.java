...
public abstract class _AiToolError extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public AiToolError cloneInstance(){
        AiToolError instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(AiToolError instance){
    ...
    protected AiToolError newInstance(){
        return (AiToolError) ClassHelper.newInstance(getClass());
    }
}
