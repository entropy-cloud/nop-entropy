...
public class CreateDirectoryExecutor implements IToolExecutor {
    public static final String TOOL_NAME = "create-dir";
    ...
    private AiToolCallResult doExecute(AiToolCall call, IToolExecuteContext context) {
        try {
            ...
            return AiToolCallResult.successResult(call.getId(), "Directory created successfully: " + path);
        } catch (Exception e) {
