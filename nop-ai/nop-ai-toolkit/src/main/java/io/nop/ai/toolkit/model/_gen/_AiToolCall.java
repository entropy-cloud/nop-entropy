...
public abstract class _AiToolCall extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private KeyedList<io.nop.ai.toolkit.model.AiToolInputFile> _inputFiles = KeyedList.emptyList();
     ...
     * 
     */
    private java.lang.String _toolName ;
    ...
    public java.util.List<io.nop.ai.toolkit.model.AiToolInputFile> getInputFiles(){
      return _inputFiles;
    }

    
    public void setInputFiles(java.util.List<io.nop.ai.toolkit.model.AiToolInputFile> value){
        checkAllowChange();
        
        this._inputFiles = KeyedList.fromList(value, io.nop.ai.toolkit.model.AiToolInputFile::getPath);
           
    }

    
    public io.nop.ai.toolkit.model.AiToolInputFile getInputFile(String name){
    ...
    public void addInputFile(io.nop.ai.toolkit.model.AiToolInputFile item) {
        checkAllowChange();
        java.util.List<io.nop.ai.toolkit.model.AiToolInputFile> list = this.getInputFiles();
        if (list == null || list.isEmpty()) {
            list = new KeyedList<>(io.nop.ai.toolkit.model.AiToolInputFile::getPath);
            setInputFiles(list);
        }
        list.add(item);
    }
    ...
    protected void outputJson(IJsonHandler out){
        ...
        out.putNotNull("toolName",this.getToolName());
    }

    public AiToolCall cloneInstance(){
        AiToolCall instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(AiToolCall instance){
        ...
        instance.setToolName(this.getToolName());
    }

    protected AiToolCall newInstance(){
        return (AiToolCall) ClassHelper.newInstance(getClass());
    }
}
