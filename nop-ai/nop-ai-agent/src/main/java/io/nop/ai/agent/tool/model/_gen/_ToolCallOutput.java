...
import io.nop.ai.agent.tool.model.ToolCallOutput;
...
public abstract class _ToolCallOutput extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public ToolCallOutput cloneInstance(){
        ToolCallOutput instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(ToolCallOutput instance){
    ...
    protected ToolCallOutput newInstance(){
        return (ToolCallOutput) ClassHelper.newInstance(getClass());
    }
}
