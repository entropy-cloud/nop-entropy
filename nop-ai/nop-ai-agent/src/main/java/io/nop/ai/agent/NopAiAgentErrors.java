 ...
 * unchanged).
 *
 * <p><b>W2 reliability sink-down (plan 2026-08-15-0604-2)</b>:
 * {@code ERR_AI_AGENT_INVALID_ARG} + {@code ARG_MSG} migrated to
 * {@link io.nop.ai.core.NopAiCoreErrors} (error code ID preserved); the
