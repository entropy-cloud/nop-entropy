...
import io.nop.ai.agent.model.AgentLifecycleModel;
...
public abstract class _AgentLifecycleModel extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public AgentLifecycleModel cloneInstance(){
        AgentLifecycleModel instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(AgentLifecycleModel instance){
    ...
    protected AgentLifecycleModel newInstance(){
        return (AgentLifecycleModel) ClassHelper.newInstance(getClass());
    }
}
