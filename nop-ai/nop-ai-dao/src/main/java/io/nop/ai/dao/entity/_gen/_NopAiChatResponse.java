...
public class _NopAiChatResponse extends DynamicOrmEntity{
    ...
    public String orm_entityName() {
      ...
      return "io.nop.ai.dao.entity.NopAiChatResponse";
    }
     ...
     * 
     */
    public final io.nop.ai.dao.entity.NopAiChatRequest getRequest(){
       return (io.nop.ai.dao.entity.NopAiChatRequest)internalGetRefEntity(PROP_NAME_request);
    }

    public final void setRequest(io.nop.ai.dao.entity.NopAiChatRequest refEntity){
     ...
     * 
     */
    public final io.nop.ai.dao.entity.NopAiModel getModel(){
       return (io.nop.ai.dao.entity.NopAiModel)internalGetRefEntity(PROP_NAME_model);
    }

    public final void setModel(io.nop.ai.dao.entity.NopAiModel refEntity){
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiGenFile> _generatedFiles = new OrmEntitySet<>(this, PROP_NAME_generatedFiles,
        io.nop.ai.dao.entity.NopAiGenFile.PROP_NAME_chatResponse, null,io.nop.ai.dao.entity.NopAiGenFile.class);
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiTestCase> _testCases = new OrmEntitySet<>(this, PROP_NAME_testCases,
        io.nop.ai.dao.entity.NopAiTestCase.PROP_NAME_chatResponse, null,io.nop.ai.dao.entity.NopAiTestCase.class);
