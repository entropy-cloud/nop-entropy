...
public class _NopAiGenFile extends DynamicOrmEntity{
    ...
    public String orm_entityName() {
      ...
      return "io.nop.ai.dao.entity.NopAiGenFile";
    }
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiGenFileHistory> _historyRecords = new OrmEntitySet<>(this, PROP_NAME_historyRecords,
        io.nop.ai.dao.entity.NopAiGenFileHistory.PROP_NAME_genFile, null,io.nop.ai.dao.entity.NopAiGenFileHistory.class);

    /**
     * 历史版本。 refPropName: genFile, keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<io.nop.ai.dao.entity.NopAiGenFileHistory> getHistoryRecords(){
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiTestCase> _testCases = new OrmEntitySet<>(this, PROP_NAME_testCases,
        io.nop.ai.dao.entity.NopAiTestCase.PROP_NAME_genFile, null,io.nop.ai.dao.entity.NopAiTestCase.class);
