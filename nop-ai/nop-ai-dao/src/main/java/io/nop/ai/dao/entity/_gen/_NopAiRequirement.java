...
public class _NopAiRequirement extends DynamicOrmEntity{
    ...
    public String orm_entityName() {
      ...
      return "io.nop.ai.dao.entity.NopAiRequirement";
    }
     ...
     * 
     */
    public final io.nop.ai.dao.entity.NopAiRequirement getParent(){
       return (io.nop.ai.dao.entity.NopAiRequirement)internalGetRefEntity(PROP_NAME_parent);
    }

    public final void setParent(io.nop.ai.dao.entity.NopAiRequirement refEntity){
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiRequirement> _children = new OrmEntitySet<>(this, PROP_NAME_children,
        io.nop.ai.dao.entity.NopAiRequirement.PROP_NAME_parent, null,io.nop.ai.dao.entity.NopAiRequirement.class);

    /**
     * 子需求。 refPropName: parent, keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<io.nop.ai.dao.entity.NopAiRequirement> getChildren(){
       return _children;
    }
       
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiRequirementHistory> _historyRecords = new OrmEntitySet<>(this, PROP_NAME_historyRecords,
        io.nop.ai.dao.entity.NopAiRequirementHistory.PROP_NAME_requirement, null,io.nop.ai.dao.entity.NopAiRequirementHistory.class);

    /**
     * 历史版本。 refPropName: requirement, keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<io.nop.ai.dao.entity.NopAiRequirementHistory> getHistoryRecords(){
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiGenFile> _generatedFiles = new OrmEntitySet<>(this, PROP_NAME_generatedFiles,
        io.nop.ai.dao.entity.NopAiGenFile.PROP_NAME_requirement, null,io.nop.ai.dao.entity.NopAiGenFile.class);
    ...
    private final OrmEntitySet<io.nop.ai.dao.entity.NopAiTestCase> _testCases = new OrmEntitySet<>(this, PROP_NAME_testCases,
        io.nop.ai.dao.entity.NopAiTestCase.PROP_NAME_requirement, null,io.nop.ai.dao.entity.NopAiTestCase.class);

    /**
     * 测试用例。 refPropName: requirement, keyProp: {rel.keyProp}
     */
    public final IOrmEntitySet<io.nop.ai.dao.entity.NopAiTestCase> getTestCases(){
       return _testCases;
    }
