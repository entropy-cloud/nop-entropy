...
CREATE TABLE nop_oauth_authorization(
  ...
  AUTHORIZATION_CODE_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'AuthorizationCode发放时间',
  AUTHORIZATION_CODE_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'AuthorizationCode过期使劲按',
  AUTHORIZATION_CODE_METADATA TEXT NULL    COMMENT 'AuthorizationCode元数据',
  ACCESS_TOKEN_VALUE TEXT NULL    COMMENT 'AccessToken',
  ACCESS_TOKEN_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'AccessToken发放时间',
  ACCESS_TOKEN_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'AccessToken过期时间',
  ...
  OIDC_ID_TOKEN_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'OidcIdToken发放时间',
  OIDC_ID_TOKEN_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'OidcIdToken过期时间',
  OIDC_ID_TOKEN_METADATA TEXT NULL    COMMENT 'OidcIdToken元数据',
  REFRESH_TOKEN_VALUE TEXT NULL    COMMENT 'RefreshToken值',
  REFRESH_TOKEN_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'RefreshToken发放时间',
  REFRESH_TOKEN_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'RefreshToken过期时间',
  REFRESH_TOKEN_METADATA TEXT NULL    COMMENT 'RefreshToken元数据',
  USER_CODE_VALUE TEXT NULL    COMMENT 'UserCode值',
  USER_CODE_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'UserCode发放时间',
  USER_CODE_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'UserCode过期时间',
  USER_CODE_METADATA TEXT NULL    COMMENT 'UserCode元数据',
  DEVICE_CODE_VALUE TEXT NULL    COMMENT 'DeviceCode值',
  DEVICE_CODE_ISSUED_AT TIMESTAMP(3) NULL    COMMENT 'DeviceCode发放时间',
  DEVICE_CODE_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT 'DeviceCode过期时间',
...
CREATE TABLE nop_oauth_registered_client(
  ...
  CLIENT_ID_ISSUED_AT TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '客户端ID发放时间',
  CLIENT_SECRET VARCHAR(200) NULL    COMMENT '客户端密码',
  CLIENT_SECRET_EXPIRES_AT TIMESTAMP(3) NULL    COMMENT '客户端密码过期时间',
