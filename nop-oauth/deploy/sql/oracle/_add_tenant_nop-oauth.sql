...
alter table nop_oauth_authorization add constraint PK_nop_oauth_authorization primary key (NOP_TENANT_ID, ID);
...
alter table nop_oauth_registered_client add constraint PK_nop_oauth_registered_client primary key (NOP_TENANT_ID, ID);
