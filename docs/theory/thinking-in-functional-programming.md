...
讲解视频: [https://www.bilibili.com/video/BV1hrADeZE6v/](https://www.bilibili.com/video/BV1hrADeZE6v/)
...
但以上观点都是片面的。因为函数式编程的内容也很丰富，并不仅仅是使用高阶函数这么简单。
函数式编程是一种通用的编程范式，它并不是一种语言特性，在Java语言中一样可以充分落实函数式编程思想。
