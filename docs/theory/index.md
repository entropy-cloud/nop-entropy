...
*   [**广义可逆计算论文 v2**](generalized-reversible-computation-paper-v2.md): 面向 arXiv 预印本目标重构的 GRC 范式与系统论文，采用“构造命题 → 变化空间设计 → 形式核心 → Nop/XLang 参考架构 → 产品线场景 → 相关工作”的主线，并引用独立形式证明文档。
