    ...
    alter table nop_task_definition add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_task_instance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_task_definition_auth add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_task_step_instance add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
