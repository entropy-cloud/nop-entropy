...
CREATE TABLE nop_task_instance(
  ...
  JOB_INSTANCE_ID VARCHAR(32) NULL    COMMENT 'Job ID',
  ...
  UPDATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '修改时间',
  REMARK VARCHAR(200) NULL    COMMENT '备注',
  ERROR_BEAN_DATA VARCHAR(4000) NULL    COMMENT '错误Bean数据',
...
CREATE TABLE nop_task_step_instance(
  ...
  STEP_STATUS INTEGER NOT NULL    COMMENT '状态',
  ...
  INTERNAL BOOLEAN NULL    COMMENT '是否内部',
  ERR_CODE VARCHAR(200) NULL    COMMENT '错误码',
  ERR_MSG VARCHAR(4000) NULL    COMMENT '错误消息',
  PRIORITY INTEGER NOT NULL    COMMENT '优先级',
  TAG_TEXT VARCHAR(200) NULL    COMMENT '标签',
  PARENT_STEP_ID VARCHAR(32) NULL    COMMENT '父步骤ID',
  WORKER_ID VARCHAR(50) NULL    COMMENT '工作者ID',
  STEP_PATH VARCHAR(2000) NULL    COMMENT '步骤路径',
  RUN_ID INTEGER NOT NULL    COMMENT '运行ID',
  BODY_STEP_INDEX INTEGER NOT NULL    COMMENT '步骤下标',
  STATE_BEAN_DATA VARCHAR(4000) NULL    COMMENT '状态数据',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '创建时间',
  UPDATED_BY VARCHAR(50) NOT NULL    COMMENT '修改人',
