...
/**
 * generate from [51:10:0:0]/nop/schema/task/task.xdef <p>
 * 如果发生异常，则重试整个task
 */
...
public abstract class _TaskRetryModel extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     */
    private io.nop.core.lang.eval.IEvalAction _exceptionFilter ;
    ...
    public io.nop.core.lang.eval.IEvalAction getExceptionFilter(){
      return _exceptionFilter;
    }

    
    public void setExceptionFilter(io.nop.core.lang.eval.IEvalAction value){
        checkAllowChange();
