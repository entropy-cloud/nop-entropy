...
CREATE TABLE nop_sys_sequence(
  ...
  IS_UUID TINYINT NOT NULL  default '0'    COMMENT '是否UUID',
...
CREATE TABLE nop_sys_lock(
  ...
  LOCK_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '锁定时间',
  EXPIRE_AT TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '过期时间',
...
CREATE TABLE nop_sys_cluster_leader(
  ...
  ELECT_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '选举时间',
  EXPIRE_AT TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '过期时间',
  APP_ID VARCHAR(100) NOT NULL    COMMENT '应用ID',
...
CREATE TABLE nop_sys_dict_option(
  ...
  IS_INTERNAL TINYINT NOT NULL  default '0'    COMMENT '是否内部',
  IS_DEPRECATED TINYINT NOT NULL  default '0'    COMMENT '是否已废弃',
  DEL_FLAG TINYINT NOT NULL    COMMENT '删除标识',
  VERSION INTEGER NOT NULL    COMMENT '数据版本',
  CREATED_BY VARCHAR(50) NOT NULL    COMMENT '创建人',
  CREATE_TIME TIMESTAMP(3) NOT NULL  DEFAULT CURRENT_TIMESTAMP(3)    COMMENT '创建时间',
