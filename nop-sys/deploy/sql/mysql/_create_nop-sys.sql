...
CREATE TABLE nop_sys_lock(
  ...
  LOCK_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '锁定时间',
  EXPIRE_AT TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '过期时间',
...
CREATE TABLE nop_sys_cluster_leader(
  ...
  ELECT_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '选举时间',
  EXPIRE_AT TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '过期时间',
  REFRESH_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '刷新时间',
...
CREATE TABLE nop_sys_event(
  ...
  EVENT_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '事件时间',
  EVENT_STATUS INTEGER NOT NULL    COMMENT '事件状态',
  PROCESS_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '处理时间',
  SCHEDULE_TIME TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3)  NOT NULL    COMMENT '调度时间',
