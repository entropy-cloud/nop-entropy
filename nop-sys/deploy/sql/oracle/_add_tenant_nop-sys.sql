...
alter table nop_sys_broadcast_event add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_sys_broadcast_cursor add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_sys_tag add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_sys_compact_ext_field add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_sys_dict_option add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table nop_sys_obj_tag add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table nop_sys_compact_ext_field drop constraint PK_nop_sys_compact_ext_field;
alter table nop_sys_compact_ext_field add constraint PK_nop_sys_compact_ext_field primary key (NOP_TENANT_ID, SID);
