 ...
 * Returns a fixed absolute time that advances only when {@link #advanceMillis(long)} is called.
 * For tests that need real-time progression (e.g., wait loops), use {@link #advanceMillis(long)}
 * to advance the clock past the wait boundary.
 */
