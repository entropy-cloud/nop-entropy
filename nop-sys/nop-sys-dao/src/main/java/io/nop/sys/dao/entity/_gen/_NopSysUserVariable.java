...
public class _NopSysUserVariable extends DynamicOrmEntity{
    ...
    public static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_userId,PROP_NAME_varName);
    public static final int[] PK_PROP_IDS = new int[]{PROP_ID_userId,PROP_ID_varName};
