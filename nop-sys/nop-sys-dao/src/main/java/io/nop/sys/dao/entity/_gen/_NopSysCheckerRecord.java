...
/**
 *  MakerChecker审批记录: nop_sys_checker_record
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _NopSysCheckerRecord extends DynamicOrmEntity{
    ...
    public _NopSysCheckerRecord(){
        // for debug
    }

    protected NopSysCheckerRecord newInstance(){
        NopSysCheckerRecord entity = new NopSysCheckerRecord();
    ...
    @Override
    public NopSysCheckerRecord cloneInstance() {
        NopSysCheckerRecord entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.sys.dao.entity.NopSysCheckerRecord";
    }
