...
public class _NopSysTag extends DynamicOrmEntity{
    ...
    protected NopSysTag newInstance(){
        NopSysTag entity = new NopSysTag();
    ...
    @Override
    public NopSysTag cloneInstance() {
        NopSysTag entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.nop.sys.dao.entity.NopSysTag";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_sid:{
               onInitProp(propId);
               this._sid = (java.lang.Long)value;
     ...
     * 主键: SID
     */
    public final void setSid(java.lang.Long value){
